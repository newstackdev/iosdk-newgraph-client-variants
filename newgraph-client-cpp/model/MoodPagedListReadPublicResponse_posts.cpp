...
utility::string_t MoodPagedListReadPublicResponse_posts::getConsentEmail() const
{
    return m_ConsentEmail;
}


void MoodPagedListReadPublicResponse_posts::setConsentEmail(utility::string_t value)
{
    m_ConsentEmail = value;
    m_ConsentEmailIsSet = true;
}
bool MoodPagedListReadPublicResponse_posts::consentEmailIsSet() const
{
    return m_ConsentEmailIsSet;
}

void MoodPagedListReadPublicResponse_posts::unsetConsentEmail()
{
    m_ConsentEmailIsSet = false;
}

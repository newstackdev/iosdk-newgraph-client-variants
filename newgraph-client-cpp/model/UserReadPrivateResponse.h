...
/*
 * UserReadPrivateResponse.h
 *
 * 
 */

#ifndef IO_SWAGGER_CLIENT_MODEL_UserReadPrivateResponse_H_
#define IO_SWAGGER_CLIENT_MODEL_UserReadPrivateResponse_H_
...
public:
    ...
    virtual ~UserReadPrivateResponse();
    ...
    /////////////////////////////////////////////
    /// UserReadPrivateResponse members
    ...
    /// 
    /// </summary>
    utility::string_t getStripeUid() const;
    bool stripeUidIsSet() const;
    void unsetStripeUid();
    void setStripeUid(utility::string_t value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    utility::string_t getSubscriptionExpiry() const;
    bool subscriptionExpiryIsSet() const;
    void unsetSubscriptionExpiry();
    void setSubscriptionExpiry(utility::string_t value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    double getAvailableInvites() const;
    bool availableInvitesIsSet() const;
    void unsetAvailableInvites();
    void setAvailableInvites(double value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    utility::string_t getNewcoinPrivateKey() const;
    bool newcoinPrivateKeyIsSet() const;
    void unsetNewcoinPrivateKey();
    void setNewcoinPrivateKey(utility::string_t value);
    /// <summary>
    /// 
    /// </summary>
    utility::string_t getSubscriptionStatus() const;
    bool subscriptionStatusIsSet() const;
    void unsetSubscriptionStatus();
    void setSubscriptionStatus(utility::string_t value);
    /// <summary>
    /// 
    /// </summary>
    utility::string_t getNewcoinPublisherPrivateKey() const;
    bool newcoinPublisherPrivateKeyIsSet() const;
    void unsetNewcoinPublisherPrivateKey();
    void setNewcoinPublisherPrivateKey(utility::string_t value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    utility::string_t m_StripeUid;
    bool m_StripeUidIsSet;
    ...
    utility::string_t m_SubscriptionExpiry;
    bool m_SubscriptionExpiryIsSet;
    utility::string_t m_Created;
    bool m_CreatedIsSet;
    double m_AvailableInvites;
    bool m_AvailableInvitesIsSet;
    ...
    utility::string_t m_NewcoinPrivateKey;
    bool m_NewcoinPrivateKeyIsSet;
    utility::string_t m_SubscriptionStatus;
    bool m_SubscriptionStatusIsSet;
    utility::string_t m_NewcoinPublisherPrivateKey;
    bool m_NewcoinPublisherPrivateKeyIsSet;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_UserReadPrivateResponse_H_ */

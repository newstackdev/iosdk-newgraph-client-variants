...
utility::string_t PostReadResponse::getEmbed() const
{
    return m_Embed;
}


void PostReadResponse::setEmbed(utility::string_t value)
{
    m_Embed = value;
    m_EmbedIsSet = true;
}
bool PostReadResponse::embedIsSet() const
{
    return m_EmbedIsSet;
}

void PostReadResponse::unsetEmbed()
{
    m_EmbedIsSet = false;
}

...
std::shared_ptr<PostCreateResponse_author> PostReadResponse::getAuthor() const
{
    return m_Author;
}


void PostReadResponse::setAuthor(std::shared_ptr<PostCreateResponse_author> value)
{
    m_Author = value;
    m_AuthorIsSet = true;
}
...
std::vector<std::shared_ptr<PostCreateResponse_moods>>& PostReadResponse::getMoods()
{
    return m_Moods;
}

void PostReadResponse::setMoods(std::vector<std::shared_ptr<PostCreateResponse_moods>> value)
{
    m_Moods = value;
    m_MoodsIsSet = true;
}

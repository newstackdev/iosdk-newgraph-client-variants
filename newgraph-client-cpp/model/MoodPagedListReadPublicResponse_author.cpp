...
MoodPagedListReadPublicResponse_author::MoodPagedListReadPublicResponse_author()
{
    ...
    m_ConfirmedSocials = utility::conversions::to_string_t("");
    m_ConfirmedSocialsIsSet = false;
...
web::json::value MoodPagedListReadPublicResponse_author::toJson() const
{
    ...
    if(m_ConfirmedSocialsIsSet)
    {
        val[utility::conversions::to_string_t("confirmedSocials")] = ModelBase::toJson(m_ConfirmedSocials);
    }
    if(m_FullNameIsSet)
    {
...
void MoodPagedListReadPublicResponse_author::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("confirmedSocials")))
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("confirmedSocials")];
        if(!fieldValue.is_null())
        {
            setConfirmedSocials(ModelBase::stringFromJson(fieldValue));
        }
    }
...
void MoodPagedListReadPublicResponse_author::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_ConfirmedSocialsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("confirmedSocials"), m_ConfirmedSocials));
...
void MoodPagedListReadPublicResponse_author::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("confirmedSocials")))
    {
        setConfirmedSocials(ModelBase::stringFromHttpContent(multipart->getContent(utility::conversions::to_string_t("confirmedSocials"))));
    }
...
utility::string_t MoodPagedListReadPublicResponse_author::getConfirmedSocials() const
{
    return m_ConfirmedSocials;
}


void MoodPagedListReadPublicResponse_author::setConfirmedSocials(utility::string_t value)
{
    m_ConfirmedSocials = value;
    m_ConfirmedSocialsIsSet = true;
}
bool MoodPagedListReadPublicResponse_author::confirmedSocialsIsSet() const
{
    return m_ConfirmedSocialsIsSet;
}

void MoodPagedListReadPublicResponse_author::unsetConfirmedSocials()
{
    m_ConfirmedSocialsIsSet = false;
}

...
utility::string_t UserReadPublicResponse::getConfirmedSocials() const
{
    return m_ConfirmedSocials;
}


void UserReadPublicResponse::setConfirmedSocials(utility::string_t value)
{
    m_ConfirmedSocials = value;
    m_ConfirmedSocialsIsSet = true;
}
bool UserReadPublicResponse::confirmedSocialsIsSet() const
{
    return m_ConfirmedSocialsIsSet;
}

void UserReadPublicResponse::unsetConfirmedSocials()
{
    m_ConfirmedSocialsIsSet = false;
}

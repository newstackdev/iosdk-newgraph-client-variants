...
std::shared_ptr<MoodPagedListReadPublicResponse_author> MoodReadResponse::getAuthor() const
{
    return m_Author;
}


void MoodReadResponse::setAuthor(std::shared_ptr<MoodPagedListReadPublicResponse_author> value)
{
    m_Author = value;
    m_AuthorIsSet = true;
}
...
std::vector<std::shared_ptr<MoodPagedListReadPublicResponse_posts>>& MoodReadResponse::getPosts()
{
    return m_Posts;
}

void MoodReadResponse::setPosts(std::vector<std::shared_ptr<MoodPagedListReadPublicResponse_posts>> value)
{
    m_Posts = value;
    m_PostsIsSet = true;
}
...
std::vector<std::shared_ptr<MoodPagedListReadPublicResponse_tags>>& MoodReadResponse::getTags()
{
    return m_Tags;
}

void MoodReadResponse::setTags(std::vector<std::shared_ptr<MoodPagedListReadPublicResponse_tags>> value)
{
    m_Tags = value;
    m_TagsIsSet = true;
}

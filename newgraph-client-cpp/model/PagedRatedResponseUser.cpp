...
PagedRatedResponseUser::PagedRatedResponseUser()
{
    m_ValueIsSet = false;
    m_Done = false;
    m_DoneIsSet = false;
...
void PagedRatedResponseUser::validate()
{
    // TODO: implement validation
}

web::json::value PagedRatedResponseUser::toJson() const
{
...
void PagedRatedResponseUser::fromJson(web::json::value& val)
{
    {
        m_Value.clear();
        std::vector<web::json::value> jsonArray;
        ...
        for( auto& item : val[utility::conversions::to_string_t("value")].as_array() )
        {
            if(item.is_null())
            {
                m_Value.push_back( std::shared_ptr<PagedRatedResponseUser_value>(nullptr) );
            }
            else
            {
                std::shared_ptr<PagedRatedResponseUser_value> newItem(new PagedRatedResponseUser_value());
...
void PagedRatedResponseUser::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PagedRatedResponseUser::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::vector<std::shared_ptr<PagedRatedResponseUser_value>>& PagedRatedResponseUser::getValue()
{
    return m_Value;
}

void PagedRatedResponseUser::setValue(std::vector<std::shared_ptr<PagedRatedResponseUser_value>> value)
{
    m_Value = value;
    m_ValueIsSet = true;
}
bool PagedRatedResponseUser::valueIsSet() const
{
    return m_ValueIsSet;
}

void PagedRatedResponseUser::unsetValue()
{
    m_ValueIsSet = false;
}

bool PagedRatedResponseUser::isDone() const
{
    return m_Done;
}


void PagedRatedResponseUser::setDone(bool value)
{
    m_Done = value;
    m_DoneIsSet = true;
}
bool PagedRatedResponseUser::doneIsSet() const
{
    return m_DoneIsSet;
}

void PagedRatedResponseUser::unsetDone()
{
    m_DoneIsSet = false;
}

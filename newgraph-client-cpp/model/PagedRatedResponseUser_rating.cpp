...
utility::string_t PagedRatedResponseUser_rating::getTxIDMintAsset() const
{
    return m_TxID_mintAsset;
}


void PagedRatedResponseUser_rating::setTxIDMintAsset(utility::string_t value)
{
    m_TxID_mintAsset = value;
    m_TxID_mintAssetIsSet = true;
}
bool PagedRatedResponseUser_rating::txIDMintAssetIsSet() const
{
    return m_TxID_mintAssetIsSet;
}

void PagedRatedResponseUser_rating::unsetTxID_mintAsset()
{
    m_TxID_mintAssetIsSet = false;
}

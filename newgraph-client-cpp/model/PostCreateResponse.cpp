...
std::shared_ptr<PostCreateResponse_author> PostCreateResponse::getAuthor() const
{
    return m_Author;
}


void PostCreateResponse::setAuthor(std::shared_ptr<PostCreateResponse_author> value)
{
    m_Author = value;
    m_AuthorIsSet = true;
}
...
std::vector<std::shared_ptr<PostCreateResponse_moods>>& PostCreateResponse::getMoods()
{
    return m_Moods;
}

void PostCreateResponse::setMoods(std::vector<std::shared_ptr<PostCreateResponse_moods>> value)
{
    m_Moods = value;
    m_MoodsIsSet = true;
}

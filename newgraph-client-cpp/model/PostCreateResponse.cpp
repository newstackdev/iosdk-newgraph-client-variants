...
utility::string_t PostCreateResponse::getConsentEmail() const
{
    return m_ConsentEmail;
}


void PostCreateResponse::setConsentEmail(utility::string_t value)
{
    m_ConsentEmail = value;
    m_ConsentEmailIsSet = true;
}
bool PostCreateResponse::consentEmailIsSet() const
{
    return m_ConsentEmailIsSet;
}

void PostCreateResponse::unsetConsentEmail()
{
    m_ConsentEmailIsSet = false;
}

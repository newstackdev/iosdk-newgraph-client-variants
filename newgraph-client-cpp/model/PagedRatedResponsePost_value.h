...
/*
 * PagedRatedResponsePost_value.h
 *
 * 
 */

#ifndef IO_SWAGGER_CLIENT_MODEL_PagedRatedResponsePost_value_H_
#define IO_SWAGGER_CLIENT_MODEL_PagedRatedResponsePost_value_H_
...
/// 
/// </summary>
class  PagedRatedResponsePost_value
    : public ModelBase
{
public:
    PagedRatedResponsePost_value();
    virtual ~PagedRatedResponsePost_value();
    ...
    /////////////////////////////////////////////
    /// PagedRatedResponsePost_value members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<PagedRatedResponsePost_moods>>& getMoods();
    bool moodsIsSet() const;
    void unsetMoods();
    void setMoods(std::vector<std::shared_ptr<PagedRatedResponsePost_moods>> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    std::vector<std::shared_ptr<PagedRatedResponsePost_moods>> m_Moods;
    bool m_MoodsIsSet;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_PagedRatedResponsePost_value_H_ */

...
/*
 * MoodCreateResponse.h
 *
 * 
 */

#ifndef IO_SWAGGER_CLIENT_MODEL_MoodCreateResponse_H_
#define IO_SWAGGER_CLIENT_MODEL_MoodCreateResponse_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<PagedRatedResponsePost_author> getAuthor() const;
    bool authorIsSet() const;
    void unsetAuthor();
    void setAuthor(std::shared_ptr<PagedRatedResponsePost_author> value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<MoodCreateResponse_posts>>& getPosts();
    bool postsIsSet() const;
    void unsetPosts();
    void setPosts(std::vector<std::shared_ptr<MoodCreateResponse_posts>> value);
    /// <summary>
    /// 
    /// </summary>
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<PagedRatedResponsePost_tags>>& getTags();
    bool tagsIsSet() const;
    void unsetTags();
    void setTags(std::vector<std::shared_ptr<PagedRatedResponsePost_tags>> value);
    /// <summary>
    /// 
    /// </summary>
...
protected:
    ...
    bool m_CreatedIsSet;
    std::shared_ptr<PagedRatedResponsePost_author> m_Author;
    bool m_AuthorIsSet;
    double m_Latitude;
    ...
    bool m_TitleIsSet;
    std::vector<std::shared_ptr<MoodCreateResponse_posts>> m_Posts;
    bool m_PostsIsSet;
    utility::string_t m_Content;
    bool m_ContentIsSet;
    double m_StakeToAccess;
    bool m_StakeToAccessIsSet;
    std::vector<std::shared_ptr<PagedRatedResponsePost_tags>> m_Tags;
    bool m_TagsIsSet;
...
#endif /* IO_SWAGGER_CLIENT_MODEL_MoodCreateResponse_H_ */

...
std::shared_ptr<MoodPagedListReadPublicResponse_author> MoodCreateResponse::getAuthor() const
{
    return m_Author;
}


void MoodCreateResponse::setAuthor(std::shared_ptr<MoodPagedListReadPublicResponse_author> value)
{
    m_Author = value;
    m_AuthorIsSet = true;
}
...
std::vector<std::shared_ptr<MoodPagedListReadPublicResponse_posts>>& MoodCreateResponse::getPosts()
{
    return m_Posts;
}

void MoodCreateResponse::setPosts(std::vector<std::shared_ptr<MoodPagedListReadPublicResponse_posts>> value)
{
    m_Posts = value;
    m_PostsIsSet = true;
}
...
std::vector<std::shared_ptr<MoodPagedListReadPublicResponse_tags>>& MoodCreateResponse::getTags()
{
    return m_Tags;
}

void MoodCreateResponse::setTags(std::vector<std::shared_ptr<MoodPagedListReadPublicResponse_tags>> value)
{
    m_Tags = value;
    m_TagsIsSet = true;
}

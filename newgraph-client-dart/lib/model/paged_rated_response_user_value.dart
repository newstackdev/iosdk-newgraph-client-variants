...
;
  ...
  static List<PagedRatedResponseUserValue> listFromJson(List<dynamic> json) {
    return json == null ? new List<PagedRatedResponseUserValue>() : json.map((value) => new PagedRatedResponseUserValue.fromJson(value)).toList();
  }

  static Map<String, PagedRatedResponseUserValue> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, PagedRatedResponseUserValue>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new PagedRatedResponseUserValue.fromJson(value));
    }
    return map;
  }
}

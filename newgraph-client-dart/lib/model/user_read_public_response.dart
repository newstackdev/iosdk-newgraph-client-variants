...
class UserReadPublicResponse {
  ...
  static List<UserReadPublicResponse> listFromJson(List<dynamic> json) {
    return json == null ? new List<UserReadPublicResponse>() : json.map((value) => new UserReadPublicResponse.fromJson(value)).toList();
  }

  static Map<String, UserReadPublicResponse> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, UserReadPublicResponse>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new UserReadPublicResponse.fromJson(value));
    }
    return map;
  }
}

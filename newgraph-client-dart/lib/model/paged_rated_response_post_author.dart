...
class PagedRatedResponsePostAuthor {
  ...
  static List<PagedRatedResponsePostAuthor> listFromJson(List<dynamic> json) {
    return json == null ? new List<PagedRatedResponsePostAuthor>() : json.map((value) => new PagedRatedResponsePostAuthor.fromJson(value)).toList();
  }

  static Map<String, PagedRatedResponsePostAuthor> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, PagedRatedResponsePostAuthor>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new PagedRatedResponsePostAuthor.fromJson(value));
    }
    return map;
  }
}

...
class UserInvitationPagedListReadPublicResponseValue {
...
;
  ...
  static List<UserInvitationPagedListReadPublicResponseValue> listFromJson(List<dynamic> json) {
    return json == null ? new List<UserInvitationPagedListReadPublicResponseValue>() : json.map((value) => new UserInvitationPagedListReadPublicResponseValue.fromJson(value)).toList();
  }

  static Map<String, UserInvitationPagedListReadPublicResponseValue> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, UserInvitationPagedListReadPublicResponseValue>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new UserInvitationPagedListReadPublicResponseValue.fromJson(value));
    }
    return map;
  }
}

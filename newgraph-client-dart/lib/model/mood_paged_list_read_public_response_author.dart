...
class MoodPagedListReadPublicResponseAuthor {
  ...
  static List<MoodPagedListReadPublicResponseAuthor> listFromJson(List<dynamic> json) {
    return json == null ? new List<MoodPagedListReadPublicResponseAuthor>() : json.map((value) => new MoodPagedListReadPublicResponseAuthor.fromJson(value)).toList();
  }

  static Map<String, MoodPagedListReadPublicResponseAuthor> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, MoodPagedListReadPublicResponseAuthor>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new MoodPagedListReadPublicResponseAuthor.fromJson(value));
    }
    return map;
  }
}

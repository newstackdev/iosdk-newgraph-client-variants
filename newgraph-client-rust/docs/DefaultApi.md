...
# **user_stake_post**
> ::models::AnyResponse user_stake_post(ctx, user_stake_request)
...
> ::models::SyncContactsResponse user_sync_contacts_post(ctx, sync_contacts_request)
...
[**::models::SyncContactsResponse**](SyncContactsResponse.md)
...
# **user_upload_post**
> ::models::UploadResponse user_upload_post(ctx, user_upload_request)
...
# **user_user_rate_post**
> ::models::RatingUpdateResponse user_user_rate_post(ctx, rating_update_request)

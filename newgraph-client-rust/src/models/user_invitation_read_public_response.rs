...
pub struct UserInvitationReadPublicResponse {
...
impl UserInvitationReadPublicResponse {
  pub fn new() -> UserInvitationReadPublicResponse {
  ...
  pub fn with_newcoin_ticker(mut self, newcoin_ticker: String) -> UserInvitationReadPublicResponse {
    self.newcoin_ticker = Some(newcoin_ticker);
    self
  }
  ...
  pub fn with_youtube(mut self, youtube: String) -> UserInvitationReadPublicResponse {
    self.youtube = Some(youtube);
    self
  }
  ...
  pub fn with_powered(mut self, powered: f32) -> UserInvitationReadPublicResponse {
    self.powered = Some(powered);
    self
  }
  ...
  pub fn with_display_name(mut self, display_name: String) -> UserInvitationReadPublicResponse {
    self.display_name = Some(display_name);
    self
  }
  ...
  pub fn with_newcoin_acc_tx(mut self, newcoin_acc_tx: String) -> UserInvitationReadPublicResponse {
    self.newcoin_acc_tx = Some(newcoin_acc_tx);
    self
  }
  ...
  pub fn with_latitude(mut self, latitude: f32) -> UserInvitationReadPublicResponse {
    self.latitude = Some(latitude);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> UserInvitationReadPublicResponse {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_newcoin_pool_id(mut self, newcoin_pool_id: String) -> UserInvitationReadPublicResponse {
    self.newcoin_pool_id = Some(newcoin_pool_id);
    self
  }
  ...
  pub fn with_tumblr(mut self, tumblr: String) -> UserInvitationReadPublicResponse {
    self.tumblr = Some(tumblr);
    self
  }
  ...
  pub fn with_aspect_ratio(mut self, aspect_ratio: f32) -> UserInvitationReadPublicResponse {
    self.aspect_ratio = Some(aspect_ratio);
    self
  }
  ...
  pub fn with_instagram(mut self, instagram: String) -> UserInvitationReadPublicResponse {
    self.instagram = Some(instagram);
    self
  }
  ...
  pub fn with_medium(mut self, medium: String) -> UserInvitationReadPublicResponse {
    self.medium = Some(medium);
    self
  }
  ...
  pub fn with_newcoin_active_public_key(mut self, newcoin_active_public_key: String) -> UserInvitationReadPublicResponse {
    self.newcoin_active_public_key = Some(newcoin_active_public_key);
    self
  }
  ...
  pub fn with_soundcloud(mut self, soundcloud: String) -> UserInvitationReadPublicResponse {
    self.soundcloud = Some(soundcloud);
    self
  }
  ...
  pub fn with_newcoin_public_key(mut self, newcoin_public_key: String) -> UserInvitationReadPublicResponse {
    self.newcoin_public_key = Some(newcoin_public_key);
    self
  }
  ...
  pub fn with_powering(mut self, powering: f32) -> UserInvitationReadPublicResponse {
    self.powering = Some(powering);
    self
  }
  ...
  pub fn with_snapchat(mut self, snapchat: String) -> UserInvitationReadPublicResponse {
    self.snapchat = Some(snapchat);
    self
  }
  ...
  pub fn with_apple(mut self, apple: String) -> UserInvitationReadPublicResponse {
    self.apple = Some(apple);
    self
  }
  ...
  pub fn with_twitter(mut self, twitter: String) -> UserInvitationReadPublicResponse {
    self.twitter = Some(twitter);
    self
  }
  ...
  pub fn with_newcoin_owner_public_key(mut self, newcoin_owner_public_key: String) -> UserInvitationReadPublicResponse {
    self.newcoin_owner_public_key = Some(newcoin_owner_public_key);
    self
  }
  ...
  pub fn with_tiktok(mut self, tiktok: String) -> UserInvitationReadPublicResponse {
    self.tiktok = Some(tiktok);
    self
  }
  ...
  pub fn with_reddit(mut self, reddit: String) -> UserInvitationReadPublicResponse {
    self.reddit = Some(reddit);
    self
  }
  ...
  pub fn with_youtube_id(mut self, youtube_id: String) -> UserInvitationReadPublicResponse {
    self.youtube_id = Some(youtube_id);
    self
  }
  ...
  pub fn with_id(mut self, id: String) -> UserInvitationReadPublicResponse {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_newcoin_pool_stake(mut self, newcoin_pool_stake: f32) -> UserInvitationReadPublicResponse {
    self.newcoin_pool_stake = Some(newcoin_pool_stake);
    self
  }
  ...
  pub fn with_content_type(mut self, content_type: String) -> UserInvitationReadPublicResponse {
    self.content_type = Some(content_type);
    self
  }
  ...
  pub fn with_signal(mut self, signal: String) -> UserInvitationReadPublicResponse {
    self.signal = Some(signal);
    self
  }
  ...
  pub fn with_longitude(mut self, longitude: f32) -> UserInvitationReadPublicResponse {
    self.longitude = Some(longitude);
    self
  }
  ...
  pub fn with_newcoin_publisher_public_key(mut self, newcoin_publisher_public_key: String) -> UserInvitationReadPublicResponse {
    self.newcoin_publisher_public_key = Some(newcoin_publisher_public_key);
    self
  }
  ...
  pub fn with_website(mut self, website: String) -> UserInvitationReadPublicResponse {
    self.website = Some(website);
    self
  }
  ...
  pub fn with_created(mut self, created: String) -> UserInvitationReadPublicResponse {
    self.created = Some(created);
    self
  }
  ...
  pub fn with_invitation(mut self, invitation: ::models::UserInvitationPagedListReadPublicResponseInvitation) -> UserInvitationReadPublicResponse {
    self.invitation = Some(invitation);
    self
  }
  ...
  pub fn with_spotify(mut self, spotify: String) -> UserInvitationReadPublicResponse {
    self.spotify = Some(spotify);
    self
  }
  ...
  pub fn with_facebook(mut self, facebook: String) -> UserInvitationReadPublicResponse {
    self.facebook = Some(facebook);
    self
  }
  ...
  pub fn with_facebook_id(mut self, facebook_id: String) -> UserInvitationReadPublicResponse {
    self.facebook_id = Some(facebook_id);
    self
  }
  ...
  pub fn with_full_name(mut self, full_name: String) -> UserInvitationReadPublicResponse {
    self.full_name = Some(full_name);
    self
  }
  ...
  pub fn with_telegram(mut self, telegram: String) -> UserInvitationReadPublicResponse {
    self.telegram = Some(telegram);
    self
  }
  ...
  pub fn with_pinterest(mut self, pinterest: String) -> UserInvitationReadPublicResponse {
    self.pinterest = Some(pinterest);
    self
  }
  ...
  pub fn with_verified_social_ids(mut self, verified_social_ids: Vec<String>) -> UserInvitationReadPublicResponse {
    self.verified_social_ids = Some(verified_social_ids);
    self
  }
  ...
  pub fn with_newcoin_pool_tx(mut self, newcoin_pool_tx: String) -> UserInvitationReadPublicResponse {
    self.newcoin_pool_tx = Some(newcoin_pool_tx);
    self
  }
  ...
  pub fn with_license(mut self, license: String) -> UserInvitationReadPublicResponse {
    self.license = Some(license);
    self
  }
  ...
  pub fn with_content_url(mut self, content_url: String) -> UserInvitationReadPublicResponse {
    self.content_url = Some(content_url);
    self
  }
  ...
  pub fn with_discord(mut self, discord: String) -> UserInvitationReadPublicResponse {
    self.discord = Some(discord);
    self
  }
  ...
  pub fn with_blur_hash(mut self, blur_hash: String) -> UserInvitationReadPublicResponse {
    self.blur_hash = Some(blur_hash);
    self
  }
  ...
  pub fn with_consent_email(mut self, consent_email: String) -> UserInvitationReadPublicResponse {
    self.consent_email = Some(consent_email);
    self
  }
  ...
  pub fn with_updated(mut self, updated: String) -> UserInvitationReadPublicResponse {
    self.updated = Some(updated);
    self
  }
  ...
  pub fn with_username(mut self, username: String) -> UserInvitationReadPublicResponse {
    self.username = Some(username);
    self
  }

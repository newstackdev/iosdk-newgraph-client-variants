...
impl Undefined {
  ...
  pub fn with_error_message(mut self, error_message: String) -> Undefined {
    self.error_message = Some(error_message);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: String) -> Undefined {
    self.error_code = Some(error_code);
    self
  }
  ...
  pub fn with_status_code(mut self, status_code: f32) -> Undefined {
    self.status_code = Some(status_code);
    self
  }

...
pub struct UserInvitationPagedListReadPublicResponseValue {
  ...
  invitation: Option<::models::UserInvitationPagedListReadPublicResponseInvitation>,
...
impl UserInvitationPagedListReadPublicResponseValue {
  pub fn new() -> UserInvitationPagedListReadPublicResponseValue {
  ...
  pub fn with_newcoin_ticker(mut self, newcoin_ticker: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.newcoin_ticker = Some(newcoin_ticker);
    self
  }
  ...
  pub fn with_youtube(mut self, youtube: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.youtube = Some(youtube);
    self
  }
  ...
  pub fn with_powered(mut self, powered: f32) -> UserInvitationPagedListReadPublicResponseValue {
    self.powered = Some(powered);
    self
  }
  ...
  pub fn with_display_name(mut self, display_name: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.display_name = Some(display_name);
    self
  }
  ...
  pub fn with_newcoin_acc_tx(mut self, newcoin_acc_tx: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.newcoin_acc_tx = Some(newcoin_acc_tx);
    self
  }
  ...
  pub fn with_latitude(mut self, latitude: f32) -> UserInvitationPagedListReadPublicResponseValue {
    self.latitude = Some(latitude);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_newcoin_pool_id(mut self, newcoin_pool_id: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.newcoin_pool_id = Some(newcoin_pool_id);
    self
  }
  ...
  pub fn with_tumblr(mut self, tumblr: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.tumblr = Some(tumblr);
    self
  }
  ...
  pub fn with_aspect_ratio(mut self, aspect_ratio: f32) -> UserInvitationPagedListReadPublicResponseValue {
    self.aspect_ratio = Some(aspect_ratio);
    self
  }
  ...
  pub fn with_instagram(mut self, instagram: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.instagram = Some(instagram);
    self
  }
  ...
  pub fn with_medium(mut self, medium: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.medium = Some(medium);
    self
  }
  ...
  pub fn with_newcoin_active_public_key(mut self, newcoin_active_public_key: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.newcoin_active_public_key = Some(newcoin_active_public_key);
    self
  }
  ...
  pub fn with_soundcloud(mut self, soundcloud: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.soundcloud = Some(soundcloud);
    self
  }
  ...
  pub fn with_newcoin_public_key(mut self, newcoin_public_key: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.newcoin_public_key = Some(newcoin_public_key);
    self
  }
  ...
  pub fn with_powering(mut self, powering: f32) -> UserInvitationPagedListReadPublicResponseValue {
    self.powering = Some(powering);
    self
  }
  ...
  pub fn with_snapchat(mut self, snapchat: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.snapchat = Some(snapchat);
    self
  }
  ...
  pub fn with_apple(mut self, apple: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.apple = Some(apple);
    self
  }
  ...
  pub fn with_twitter(mut self, twitter: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.twitter = Some(twitter);
    self
  }
  ...
  pub fn with_newcoin_owner_public_key(mut self, newcoin_owner_public_key: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.newcoin_owner_public_key = Some(newcoin_owner_public_key);
    self
  }
  ...
  pub fn with_tiktok(mut self, tiktok: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.tiktok = Some(tiktok);
    self
  }
  ...
  pub fn with_reddit(mut self, reddit: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.reddit = Some(reddit);
    self
  }
  ...
  pub fn with_youtube_id(mut self, youtube_id: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.youtube_id = Some(youtube_id);
    self
  }
  ...
  pub fn with_id(mut self, id: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_newcoin_pool_stake(mut self, newcoin_pool_stake: f32) -> UserInvitationPagedListReadPublicResponseValue {
    self.newcoin_pool_stake = Some(newcoin_pool_stake);
    self
  }
  ...
  pub fn with_content_type(mut self, content_type: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.content_type = Some(content_type);
    self
  }
  ...
  pub fn with_signal(mut self, signal: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.signal = Some(signal);
    self
  }
  ...
  pub fn with_longitude(mut self, longitude: f32) -> UserInvitationPagedListReadPublicResponseValue {
    self.longitude = Some(longitude);
    self
  }
  ...
  pub fn with_newcoin_publisher_public_key(mut self, newcoin_publisher_public_key: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.newcoin_publisher_public_key = Some(newcoin_publisher_public_key);
    self
  }
  ...
  pub fn with_website(mut self, website: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.website = Some(website);
    self
  }
  ...
  pub fn with_created(mut self, created: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.created = Some(created);
    self
  }
  ...
  pub fn set_invitation(&mut self, invitation: ::models::UserInvitationPagedListReadPublicResponseInvitation) {
    self.invitation = Some(invitation);
  }

  pub fn with_invitation(mut self, invitation: ::models::UserInvitationPagedListReadPublicResponseInvitation) -> UserInvitationPagedListReadPublicResponseValue {
    self.invitation = Some(invitation);
    self
  }

  pub fn invitation(&self) -> Option<&::models::UserInvitationPagedListReadPublicResponseInvitation> {
    self.invitation.as_ref()
  }

  pub fn reset_invitation(&mut self) {
  ...
  pub fn with_spotify(mut self, spotify: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.spotify = Some(spotify);
    self
  }
  ...
  pub fn with_facebook(mut self, facebook: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.facebook = Some(facebook);
    self
  }
  ...
  pub fn with_facebook_id(mut self, facebook_id: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.facebook_id = Some(facebook_id);
    self
  }
  ...
  pub fn with_full_name(mut self, full_name: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.full_name = Some(full_name);
    self
  }
  ...
  pub fn with_telegram(mut self, telegram: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.telegram = Some(telegram);
    self
  }
  ...
  pub fn with_pinterest(mut self, pinterest: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.pinterest = Some(pinterest);
    self
  }
  ...
  pub fn with_verified_social_ids(mut self, verified_social_ids: Vec<String>) -> UserInvitationPagedListReadPublicResponseValue {
    self.verified_social_ids = Some(verified_social_ids);
    self
  }
  ...
  pub fn with_newcoin_pool_tx(mut self, newcoin_pool_tx: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.newcoin_pool_tx = Some(newcoin_pool_tx);
    self
  }
  ...
  pub fn with_license(mut self, license: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.license = Some(license);
    self
  }
  ...
  pub fn with_content_url(mut self, content_url: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.content_url = Some(content_url);
    self
  }
  ...
  pub fn with_discord(mut self, discord: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.discord = Some(discord);
    self
  }
  ...
  pub fn with_blur_hash(mut self, blur_hash: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.blur_hash = Some(blur_hash);
    self
  }
  ...
  pub fn with_consent_email(mut self, consent_email: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.consent_email = Some(consent_email);
    self
  }
  ...
  pub fn with_updated(mut self, updated: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.updated = Some(updated);
    self
  }
  ...
  pub fn with_username(mut self, username: String) -> UserInvitationPagedListReadPublicResponseValue {
    self.username = Some(username);
    self
  }

...
pub struct PostCreateResponseMoods {
...
impl PostCreateResponseMoods {
  pub fn new() -> PostCreateResponseMoods {
  ...
  pub fn with_created(mut self, created: String) -> PostCreateResponseMoods {
    self.created = Some(created);
    self
  }
  ...
  pub fn with_author(mut self, author: ::models::PostCreateResponseAuthor) -> PostCreateResponseMoods {
    self.author = Some(author);
    self
  }
  ...
  pub fn with_latitude(mut self, latitude: f32) -> PostCreateResponseMoods {
    self.latitude = Some(latitude);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> PostCreateResponseMoods {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_aspect_ratio(mut self, aspect_ratio: f32) -> PostCreateResponseMoods {
    self.aspect_ratio = Some(aspect_ratio);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> PostCreateResponseMoods {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_content(mut self, content: String) -> PostCreateResponseMoods {
    self.content = Some(content);
    self
  }
  ...
  pub fn with_stake_to_access(mut self, stake_to_access: f32) -> PostCreateResponseMoods {
    self.stake_to_access = Some(stake_to_access);
    self
  }
  ...
  pub fn with_tags(mut self, tags: Vec<::models::MoodPagedListReadPublicResponseTags>) -> PostCreateResponseMoods {
    self.tags = Some(tags);
    self
  }
  ...
  pub fn with_content_url(mut self, content_url: String) -> PostCreateResponseMoods {
    self.content_url = Some(content_url);
    self
  }
  ...
  pub fn with_posts_count(mut self, posts_count: f32) -> PostCreateResponseMoods {
    self.posts_count = Some(posts_count);
    self
  }
  ...
  pub fn with_blur_hash(mut self, blur_hash: String) -> PostCreateResponseMoods {
    self.blur_hash = Some(blur_hash);
    self
  }
  ...
  pub fn with_id(mut self, id: String) -> PostCreateResponseMoods {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_updated(mut self, updated: String) -> PostCreateResponseMoods {
    self.updated = Some(updated);
    self
  }
  ...
  pub fn with_content_type(mut self, content_type: String) -> PostCreateResponseMoods {
    self.content_type = Some(content_type);
    self
  }
  ...
  pub fn with_longitude(mut self, longitude: f32) -> PostCreateResponseMoods {
    self.longitude = Some(longitude);
    self
  }

...
impl MoodPagedListReadPublicResponseAuthor {
  ...
  pub fn with_youtube_id(mut self, youtube_id: String) -> MoodPagedListReadPublicResponseAuthor {
    self.youtube_id = Some(youtube_id);
    self
  }
  ...
  pub fn with_facebook_id(mut self, facebook_id: String) -> MoodPagedListReadPublicResponseAuthor {
    self.facebook_id = Some(facebook_id);
    self
  }

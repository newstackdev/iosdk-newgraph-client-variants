...
pub struct MoodPagedListReadPublicResponseAuthor {
  ...
  #[serde(rename = "confirmedSocials")]
  confirmed_socials: Option<String>,
...
impl MoodPagedListReadPublicResponseAuthor {
  ...
  pub fn with_youtube(mut self, youtube: String) -> MoodPagedListReadPublicResponseAuthor {
    self.youtube = Some(youtube);
    self
  }
  ...
  pub fn with_medium(mut self, medium: String) -> MoodPagedListReadPublicResponseAuthor {
    self.medium = Some(medium);
    self
  }
  ...
  pub fn with_snapchat(mut self, snapchat: String) -> MoodPagedListReadPublicResponseAuthor {
    self.snapchat = Some(snapchat);
    self
  }
  ...
  pub fn with_apple(mut self, apple: String) -> MoodPagedListReadPublicResponseAuthor {
    self.apple = Some(apple);
    self
  }
  ...
  pub fn with_reddit(mut self, reddit: String) -> MoodPagedListReadPublicResponseAuthor {
    self.reddit = Some(reddit);
    self
  }
  ...
  pub fn with_signal(mut self, signal: String) -> MoodPagedListReadPublicResponseAuthor {
    self.signal = Some(signal);
    self
  }
  ...
  pub fn with_spotify(mut self, spotify: String) -> MoodPagedListReadPublicResponseAuthor {
    self.spotify = Some(spotify);
    self
  }
  ...
  pub fn with_facebook(mut self, facebook: String) -> MoodPagedListReadPublicResponseAuthor {
    self.facebook = Some(facebook);
    self
  }
  ...
  pub fn set_confirmed_socials(&mut self, confirmed_socials: String) {
    self.confirmed_socials = Some(confirmed_socials);
  }

  pub fn with_confirmed_socials(mut self, confirmed_socials: String) -> MoodPagedListReadPublicResponseAuthor {
    self.confirmed_socials = Some(confirmed_socials);
    self
  }

  pub fn confirmed_socials(&self) -> Option<&String> {
    self.confirmed_socials.as_ref()
  }

  pub fn reset_confirmed_socials(&mut self) {
    self.confirmed_socials = None;
  }
  ...
  pub fn with_telegram(mut self, telegram: String) -> MoodPagedListReadPublicResponseAuthor {
    self.telegram = Some(telegram);
    self
  }
  ...
  pub fn with_pinterest(mut self, pinterest: String) -> MoodPagedListReadPublicResponseAuthor {
    self.pinterest = Some(pinterest);
    self
  }
  ...
  pub fn with_verified_social_ids(mut self, verified_social_ids: Vec<String>) -> MoodPagedListReadPublicResponseAuthor {
    self.verified_social_ids = Some(verified_social_ids);
    self
  }
  ...
  pub fn with_discord(mut self, discord: String) -> MoodPagedListReadPublicResponseAuthor {
    self.discord = Some(discord);
    self
  }

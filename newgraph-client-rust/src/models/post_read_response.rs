...
/// PostReadResponse : PostReadResponse Model
...
impl PostReadResponse {
  ...
  pub fn with_author(mut self, author: ::models::MoodPagedListReadPublicResponseAuthor) -> PostReadResponse {
    self.author = Some(author);
    self
  }
  ...
  pub fn with_moods(mut self, moods: Vec<::models::MoodPagedListReadPublicResponseMoods>) -> PostReadResponse {
    self.moods = Some(moods);
    self
  }
  ...
  pub fn with_consent_email(mut self, consent_email: String) -> PostReadResponse {
    self.consent_email = Some(consent_email);
    self
  }

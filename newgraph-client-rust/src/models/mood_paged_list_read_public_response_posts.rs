...
pub struct MoodPagedListReadPublicResponsePosts {
...
impl MoodPagedListReadPublicResponsePosts {
  pub fn new() -> MoodPagedListReadPublicResponsePosts {
  ...
  pub fn with_cover_content_url(mut self, cover_content_url: String) -> MoodPagedListReadPublicResponsePosts {
    self.cover_content_url = Some(cover_content_url);
    self
  }
  ...
  pub fn with_mood_id(mut self, mood_id: String) -> MoodPagedListReadPublicResponsePosts {
    self.mood_id = Some(mood_id);
    self
  }
  ...
  pub fn with_created(mut self, created: String) -> MoodPagedListReadPublicResponsePosts {
    self.created = Some(created);
    self
  }
  ...
  pub fn with_author(mut self, author: ::models::MoodPagedListReadPublicResponseAuthor) -> MoodPagedListReadPublicResponsePosts {
    self.author = Some(author);
    self
  }
  ...
  pub fn with_latitude(mut self, latitude: f32) -> MoodPagedListReadPublicResponsePosts {
    self.latitude = Some(latitude);
    self
  }
  ...
  pub fn with_moods(mut self, moods: Vec<::models::MoodPagedListReadPublicResponseMoods>) -> MoodPagedListReadPublicResponsePosts {
    self.moods = Some(moods);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> MoodPagedListReadPublicResponsePosts {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_aspect_ratio(mut self, aspect_ratio: f32) -> MoodPagedListReadPublicResponsePosts {
    self.aspect_ratio = Some(aspect_ratio);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> MoodPagedListReadPublicResponsePosts {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_content(mut self, content: String) -> MoodPagedListReadPublicResponsePosts {
    self.content = Some(content);
    self
  }
  ...
  pub fn with_tags(mut self, tags: Vec<::models::MoodPagedListReadPublicResponseTags>) -> MoodPagedListReadPublicResponsePosts {
    self.tags = Some(tags);
    self
  }
  ...
  pub fn with_license(mut self, license: String) -> MoodPagedListReadPublicResponsePosts {
    self.license = Some(license);
    self
  }
  ...
  pub fn with_content_url(mut self, content_url: String) -> MoodPagedListReadPublicResponsePosts {
    self.content_url = Some(content_url);
    self
  }
  ...
  pub fn with_blur_hash(mut self, blur_hash: String) -> MoodPagedListReadPublicResponsePosts {
    self.blur_hash = Some(blur_hash);
    self
  }
  ...
  pub fn with_newcoin_mint_tx(mut self, newcoin_mint_tx: String) -> MoodPagedListReadPublicResponsePosts {
    self.newcoin_mint_tx = Some(newcoin_mint_tx);
    self
  }
  ...
  pub fn with_id(mut self, id: String) -> MoodPagedListReadPublicResponsePosts {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_consent_email(mut self, consent_email: String) -> MoodPagedListReadPublicResponsePosts {
    self.consent_email = Some(consent_email);
    self
  }
  ...
  pub fn with_updated(mut self, updated: String) -> MoodPagedListReadPublicResponsePosts {
    self.updated = Some(updated);
    self
  }
  ...
  pub fn with_content_type(mut self, content_type: String) -> MoodPagedListReadPublicResponsePosts {
    self.content_type = Some(content_type);
    self
  }
  ...
  pub fn with_longitude(mut self, longitude: f32) -> MoodPagedListReadPublicResponsePosts {
    self.longitude = Some(longitude);
    self
  }

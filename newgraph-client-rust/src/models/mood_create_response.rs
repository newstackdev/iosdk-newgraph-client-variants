...
impl MoodCreateResponse {
  ...
  pub fn with_author(mut self, author: ::models::MoodPagedListReadPublicResponseAuthor) -> MoodCreateResponse {
    self.author = Some(author);
    self
  }
  ...
  pub fn with_posts(mut self, posts: Vec<::models::MoodPagedListReadPublicResponsePosts>) -> MoodCreateResponse {
    self.posts = Some(posts);
    self
  }
  ...
  pub fn with_tags(mut self, tags: Vec<::models::MoodPagedListReadPublicResponseTags>) -> MoodCreateResponse {
    self.tags = Some(tags);
    self
  }

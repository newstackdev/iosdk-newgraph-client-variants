...
impl MoodReadResponse {
  ...
  pub fn with_author(mut self, author: ::models::MoodPagedListReadPublicResponseAuthor) -> MoodReadResponse {
    self.author = Some(author);
    self
  }
  ...
  pub fn with_posts(mut self, posts: Vec<::models::MoodPagedListReadPublicResponsePosts>) -> MoodReadResponse {
    self.posts = Some(posts);
    self
  }
  ...
  pub fn with_tags(mut self, tags: Vec<::models::MoodPagedListReadPublicResponseTags>) -> MoodReadResponse {
    self.tags = Some(tags);
    self
  }

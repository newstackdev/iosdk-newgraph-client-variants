...
impl BcAuthEthRequest {
  ...
  pub fn with_encrypted_payload(mut self, encrypted_payload: String) -> BcAuthEthRequest {
    self.encrypted_payload = Some(encrypted_payload);
    self
  }
  ...
  pub fn with_payload(mut self, payload: String) -> BcAuthEthRequest {
    self.payload = Some(payload);
    self
  }

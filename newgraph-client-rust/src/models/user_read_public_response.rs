...
pub struct UserReadPublicResponse {
...
impl UserReadPublicResponse {
  pub fn new() -> UserReadPublicResponse {
  ...
  pub fn with_newcoin_ticker(mut self, newcoin_ticker: String) -> UserReadPublicResponse {
    self.newcoin_ticker = Some(newcoin_ticker);
    self
  }
  ...
  pub fn with_youtube(mut self, youtube: String) -> UserReadPublicResponse {
    self.youtube = Some(youtube);
    self
  }
  ...
  pub fn with_powered(mut self, powered: f32) -> UserReadPublicResponse {
    self.powered = Some(powered);
    self
  }
  ...
  pub fn with_display_name(mut self, display_name: String) -> UserReadPublicResponse {
    self.display_name = Some(display_name);
    self
  }
  ...
  pub fn with_newcoin_acc_tx(mut self, newcoin_acc_tx: String) -> UserReadPublicResponse {
    self.newcoin_acc_tx = Some(newcoin_acc_tx);
    self
  }
  ...
  pub fn with_latitude(mut self, latitude: f32) -> UserReadPublicResponse {
    self.latitude = Some(latitude);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> UserReadPublicResponse {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_newcoin_pool_id(mut self, newcoin_pool_id: String) -> UserReadPublicResponse {
    self.newcoin_pool_id = Some(newcoin_pool_id);
    self
  }
  ...
  pub fn with_tumblr(mut self, tumblr: String) -> UserReadPublicResponse {
    self.tumblr = Some(tumblr);
    self
  }
  ...
  pub fn with_aspect_ratio(mut self, aspect_ratio: f32) -> UserReadPublicResponse {
    self.aspect_ratio = Some(aspect_ratio);
    self
  }
  ...
  pub fn with_instagram(mut self, instagram: String) -> UserReadPublicResponse {
    self.instagram = Some(instagram);
    self
  }
  ...
  pub fn with_medium(mut self, medium: String) -> UserReadPublicResponse {
    self.medium = Some(medium);
    self
  }
  ...
  pub fn with_newcoin_active_public_key(mut self, newcoin_active_public_key: String) -> UserReadPublicResponse {
    self.newcoin_active_public_key = Some(newcoin_active_public_key);
    self
  }
  ...
  pub fn with_soundcloud(mut self, soundcloud: String) -> UserReadPublicResponse {
    self.soundcloud = Some(soundcloud);
    self
  }
  ...
  pub fn with_newcoin_public_key(mut self, newcoin_public_key: String) -> UserReadPublicResponse {
    self.newcoin_public_key = Some(newcoin_public_key);
    self
  }
  ...
  pub fn with_powering(mut self, powering: f32) -> UserReadPublicResponse {
    self.powering = Some(powering);
    self
  }
  ...
  pub fn with_snapchat(mut self, snapchat: String) -> UserReadPublicResponse {
    self.snapchat = Some(snapchat);
    self
  }
  ...
  pub fn with_apple(mut self, apple: String) -> UserReadPublicResponse {
    self.apple = Some(apple);
    self
  }
  ...
  pub fn with_twitter(mut self, twitter: String) -> UserReadPublicResponse {
    self.twitter = Some(twitter);
    self
  }
  ...
  pub fn with_newcoin_owner_public_key(mut self, newcoin_owner_public_key: String) -> UserReadPublicResponse {
    self.newcoin_owner_public_key = Some(newcoin_owner_public_key);
    self
  }
  ...
  pub fn with_tiktok(mut self, tiktok: String) -> UserReadPublicResponse {
    self.tiktok = Some(tiktok);
    self
  }
  ...
  pub fn with_reddit(mut self, reddit: String) -> UserReadPublicResponse {
    self.reddit = Some(reddit);
    self
  }
  ...
  pub fn with_id(mut self, id: String) -> UserReadPublicResponse {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_newcoin_pool_stake(mut self, newcoin_pool_stake: f32) -> UserReadPublicResponse {
    self.newcoin_pool_stake = Some(newcoin_pool_stake);
    self
  }
  ...
  pub fn with_content_type(mut self, content_type: String) -> UserReadPublicResponse {
    self.content_type = Some(content_type);
    self
  }
  ...
  pub fn with_signal(mut self, signal: String) -> UserReadPublicResponse {
    self.signal = Some(signal);
    self
  }
  ...
  pub fn with_longitude(mut self, longitude: f32) -> UserReadPublicResponse {
    self.longitude = Some(longitude);
    self
  }
  ...
  pub fn with_newcoin_publisher_public_key(mut self, newcoin_publisher_public_key: String) -> UserReadPublicResponse {
    self.newcoin_publisher_public_key = Some(newcoin_publisher_public_key);
    self
  }
  ...
  pub fn with_website(mut self, website: String) -> UserReadPublicResponse {
    self.website = Some(website);
    self
  }
  ...
  pub fn with_created(mut self, created: String) -> UserReadPublicResponse {
    self.created = Some(created);
    self
  }
  ...
  pub fn with_spotify(mut self, spotify: String) -> UserReadPublicResponse {
    self.spotify = Some(spotify);
    self
  }
  ...
  pub fn with_facebook(mut self, facebook: String) -> UserReadPublicResponse {
    self.facebook = Some(facebook);
    self
  }
  ...
  pub fn with_confirmed_socials(mut self, confirmed_socials: String) -> UserReadPublicResponse {
    self.confirmed_socials = Some(confirmed_socials);
    self
  }
  ...
  pub fn with_full_name(mut self, full_name: String) -> UserReadPublicResponse {
    self.full_name = Some(full_name);
    self
  }
  ...
  pub fn with_telegram(mut self, telegram: String) -> UserReadPublicResponse {
    self.telegram = Some(telegram);
    self
  }
  ...
  pub fn with_pinterest(mut self, pinterest: String) -> UserReadPublicResponse {
    self.pinterest = Some(pinterest);
    self
  }
  ...
  pub fn with_verified_social_ids(mut self, verified_social_ids: Vec<String>) -> UserReadPublicResponse {
    self.verified_social_ids = Some(verified_social_ids);
    self
  }
  ...
  pub fn with_newcoin_pool_tx(mut self, newcoin_pool_tx: String) -> UserReadPublicResponse {
    self.newcoin_pool_tx = Some(newcoin_pool_tx);
    self
  }
  ...
  pub fn with_license(mut self, license: String) -> UserReadPublicResponse {
    self.license = Some(license);
    self
  }
  ...
  pub fn with_content_url(mut self, content_url: String) -> UserReadPublicResponse {
    self.content_url = Some(content_url);
    self
  }
  ...
  pub fn with_discord(mut self, discord: String) -> UserReadPublicResponse {
    self.discord = Some(discord);
    self
  }
  ...
  pub fn with_blur_hash(mut self, blur_hash: String) -> UserReadPublicResponse {
    self.blur_hash = Some(blur_hash);
    self
  }
  ...
  pub fn with_consent_email(mut self, consent_email: String) -> UserReadPublicResponse {
    self.consent_email = Some(consent_email);
    self
  }
  ...
  pub fn with_updated(mut self, updated: String) -> UserReadPublicResponse {
    self.updated = Some(updated);
    self
  }
  ...
  pub fn with_username(mut self, username: String) -> UserReadPublicResponse {
    self.username = Some(username);
    self
  }

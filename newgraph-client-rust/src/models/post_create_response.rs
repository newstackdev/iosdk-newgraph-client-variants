...
impl PostCreateResponse {
  ...
  pub fn with_cover_content_url(mut self, cover_content_url: String) -> PostCreateResponse {
    self.cover_content_url = Some(cover_content_url);
    self
  }
  ...
  pub fn with_mood_id(mut self, mood_id: String) -> PostCreateResponse {
    self.mood_id = Some(mood_id);
    self
  }
  ...
  pub fn with_created(mut self, created: String) -> PostCreateResponse {
    self.created = Some(created);
    self
  }
  ...
  pub fn with_author(mut self, author: ::models::PostCreateResponseAuthor) -> PostCreateResponse {
    self.author = Some(author);
    self
  }
  ...
  pub fn with_latitude(mut self, latitude: f32) -> PostCreateResponse {
    self.latitude = Some(latitude);
    self
  }
  ...
  pub fn with_moods(mut self, moods: Vec<::models::PostCreateResponseMoods>) -> PostCreateResponse {
    self.moods = Some(moods);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> PostCreateResponse {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_aspect_ratio(mut self, aspect_ratio: f32) -> PostCreateResponse {
    self.aspect_ratio = Some(aspect_ratio);
    self
  }
  ...
  pub fn with_title(mut self, title: String) -> PostCreateResponse {
    self.title = Some(title);
    self
  }
  ...
  pub fn with_content(mut self, content: String) -> PostCreateResponse {
    self.content = Some(content);
    self
  }
  ...
  pub fn with_tags(mut self, tags: Vec<::models::MoodPagedListReadPublicResponseTags>) -> PostCreateResponse {
    self.tags = Some(tags);
    self
  }
  ...
  pub fn with_license(mut self, license: String) -> PostCreateResponse {
    self.license = Some(license);
    self
  }
  ...
  pub fn with_content_url(mut self, content_url: String) -> PostCreateResponse {
    self.content_url = Some(content_url);
    self
  }
  ...
  pub fn with_blur_hash(mut self, blur_hash: String) -> PostCreateResponse {
    self.blur_hash = Some(blur_hash);
    self
  }
  ...
  pub fn with_newcoin_mint_tx(mut self, newcoin_mint_tx: String) -> PostCreateResponse {
    self.newcoin_mint_tx = Some(newcoin_mint_tx);
    self
  }
  ...
  pub fn with_id(mut self, id: String) -> PostCreateResponse {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_embed(mut self, embed: String) -> PostCreateResponse {
    self.embed = Some(embed);
    self
  }
  ...
  pub fn with_updated(mut self, updated: String) -> PostCreateResponse {
    self.updated = Some(updated);
    self
  }
  ...
  pub fn with_content_type(mut self, content_type: String) -> PostCreateResponse {
    self.content_type = Some(content_type);
    self
  }
  ...
  pub fn with_longitude(mut self, longitude: f32) -> PostCreateResponse {
    self.longitude = Some(longitude);
    self
  }

...
/// PostCreateResponse : PostCreateResponse Model
...
impl PostCreateResponse {
  ...
  pub fn with_author(mut self, author: ::models::MoodPagedListReadPublicResponseAuthor) -> PostCreateResponse {
    self.author = Some(author);
    self
  }
  ...
  pub fn with_moods(mut self, moods: Vec<::models::MoodPagedListReadPublicResponseMoods>) -> PostCreateResponse {
    self.moods = Some(moods);
    self
  }
  ...
  pub fn with_consent_email(mut self, consent_email: String) -> PostCreateResponse {
    self.consent_email = Some(consent_email);
    self
  }

...
pub struct PagedRatedResponsePostAuthor {
...
impl PagedRatedResponsePostAuthor {
  pub fn new() -> PagedRatedResponsePostAuthor {
  ...
  pub fn with_powered(mut self, powered: f32) -> PagedRatedResponsePostAuthor {
    self.powered = Some(powered);
    self
  }
  ...
  pub fn with_display_name(mut self, display_name: String) -> PagedRatedResponsePostAuthor {
    self.display_name = Some(display_name);
    self
  }
  ...
  pub fn with_newcoin_acc_tx(mut self, newcoin_acc_tx: String) -> PagedRatedResponsePostAuthor {
    self.newcoin_acc_tx = Some(newcoin_acc_tx);
    self
  }
  ...
  pub fn with_latitude(mut self, latitude: f32) -> PagedRatedResponsePostAuthor {
    self.latitude = Some(latitude);
    self
  }
  ...
  pub fn with_tumblr(mut self, tumblr: String) -> PagedRatedResponsePostAuthor {
    self.tumblr = Some(tumblr);
    self
  }
  ...
  pub fn with_description(mut self, description: String) -> PagedRatedResponsePostAuthor {
    self.description = Some(description);
    self
  }
  ...
  pub fn with_newcoin_pool_id(mut self, newcoin_pool_id: String) -> PagedRatedResponsePostAuthor {
    self.newcoin_pool_id = Some(newcoin_pool_id);
    self
  }
  ...
  pub fn with_aspect_ratio(mut self, aspect_ratio: f32) -> PagedRatedResponsePostAuthor {
    self.aspect_ratio = Some(aspect_ratio);
    self
  }
  ...
  pub fn with_instagram(mut self, instagram: String) -> PagedRatedResponsePostAuthor {
    self.instagram = Some(instagram);
    self
  }
  ...
  pub fn with_soundcloud(mut self, soundcloud: String) -> PagedRatedResponsePostAuthor {
    self.soundcloud = Some(soundcloud);
    self
  }
  ...
  pub fn with_newcoin_active_public_key(mut self, newcoin_active_public_key: String) -> PagedRatedResponsePostAuthor {
    self.newcoin_active_public_key = Some(newcoin_active_public_key);
    self
  }
  ...
  pub fn with_newcoin_public_key(mut self, newcoin_public_key: String) -> PagedRatedResponsePostAuthor {
    self.newcoin_public_key = Some(newcoin_public_key);
    self
  }
  ...
  pub fn with_powering(mut self, powering: f32) -> PagedRatedResponsePostAuthor {
    self.powering = Some(powering);
    self
  }
  ...
  pub fn with_twitter(mut self, twitter: String) -> PagedRatedResponsePostAuthor {
    self.twitter = Some(twitter);
    self
  }
  ...
  pub fn with_newcoin_owner_public_key(mut self, newcoin_owner_public_key: String) -> PagedRatedResponsePostAuthor {
    self.newcoin_owner_public_key = Some(newcoin_owner_public_key);
    self
  }
  ...
  pub fn with_tiktok(mut self, tiktok: String) -> PagedRatedResponsePostAuthor {
    self.tiktok = Some(tiktok);
    self
  }
  ...
  pub fn with_id(mut self, id: String) -> PagedRatedResponsePostAuthor {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_newcoin_pool_stake(mut self, newcoin_pool_stake: f32) -> PagedRatedResponsePostAuthor {
    self.newcoin_pool_stake = Some(newcoin_pool_stake);
    self
  }
  ...
  pub fn with_content_type(mut self, content_type: String) -> PagedRatedResponsePostAuthor {
    self.content_type = Some(content_type);
    self
  }
  ...
  pub fn with_longitude(mut self, longitude: f32) -> PagedRatedResponsePostAuthor {
    self.longitude = Some(longitude);
    self
  }
  ...
  pub fn with_newcoin_publisher_public_key(mut self, newcoin_publisher_public_key: String) -> PagedRatedResponsePostAuthor {
    self.newcoin_publisher_public_key = Some(newcoin_publisher_public_key);
    self
  }
  ...
  pub fn with_website(mut self, website: String) -> PagedRatedResponsePostAuthor {
    self.website = Some(website);
    self
  }
  ...
  pub fn with_created(mut self, created: String) -> PagedRatedResponsePostAuthor {
    self.created = Some(created);
    self
  }
  ...
  pub fn with_full_name(mut self, full_name: String) -> PagedRatedResponsePostAuthor {
    self.full_name = Some(full_name);
    self
  }
  ...
  pub fn with_newcoin_pool_tx(mut self, newcoin_pool_tx: String) -> PagedRatedResponsePostAuthor {
    self.newcoin_pool_tx = Some(newcoin_pool_tx);
    self
  }
  ...
  pub fn with_license(mut self, license: String) -> PagedRatedResponsePostAuthor {
    self.license = Some(license);
    self
  }
  ...
  pub fn with_content_url(mut self, content_url: String) -> PagedRatedResponsePostAuthor {
    self.content_url = Some(content_url);
    self
  }
  ...
  pub fn with_blur_hash(mut self, blur_hash: String) -> PagedRatedResponsePostAuthor {
    self.blur_hash = Some(blur_hash);
    self
  }
  ...
  pub fn with_consent_email(mut self, consent_email: String) -> PagedRatedResponsePostAuthor {
    self.consent_email = Some(consent_email);
    self
  }
  ...
  pub fn with_updated(mut self, updated: String) -> PagedRatedResponsePostAuthor {
    self.updated = Some(updated);
    self
  }
  ...
  pub fn with_username(mut self, username: String) -> PagedRatedResponsePostAuthor {
    self.username = Some(username);
    self
  }

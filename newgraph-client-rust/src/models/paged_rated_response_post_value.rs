...
impl PagedRatedResponsePostValue {
  ...
  pub fn with_author(mut self, author: ::models::PagedRatedResponsePostAuthor) -> PagedRatedResponsePostValue {
    self.author = Some(author);
    self
  }
  ...
  pub fn with_moods(mut self, moods: Vec<::models::PagedRatedResponsePostMoods>) -> PagedRatedResponsePostValue {
    self.moods = Some(moods);
    self
  }
  ...
  pub fn with_tags(mut self, tags: Vec<::models::PagedRatedResponsePostTags>) -> PagedRatedResponsePostValue {
    self.tags = Some(tags);
    self
  }
  ...
  pub fn with_consent_email(mut self, consent_email: String) -> PagedRatedResponsePostValue {
    self.consent_email = Some(consent_email);
    self
  }

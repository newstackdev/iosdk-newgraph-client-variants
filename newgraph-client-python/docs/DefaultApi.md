...
try:
    api_response = api_instance.post_rate_post(rating_update_request)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->post_rate_post: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling DefaultApi->post_report_options: %s\n" % e)
```
...
# create an instance of the API class
api_instance = swagger_client.DefaultApi(swagger_client.ApiClient(configuration))
report_update_request = swagger_client.ReportUpdateRequest() # ReportUpdateRequest | 

try:
    api_response = api_instance.post_report_post(report_update_request)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->post_report_post: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling DefaultApi->post_upload_options: %s\n" % e)
```
...
# **post_upload_post**
> UploadResponse post_upload_post(upload_request_generic)
...
try:
    api_response = api_instance.post_upload_post(upload_request_generic)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->post_upload_post: %s\n" % e)
```
...
# **search_creative_get**
> CreativeSearchResponse search_creative_get(aesthetics=aesthetics, tags=tags, page=page)
...
# create an instance of the API class
api_instance = swagger_client.DefaultApi(swagger_client.ApiClient(configuration))
aesthetics = 'aesthetics_example' # str |  (optional)
tags = 'tags_example' # str |  (optional)
page = 'page_example' # str |  (optional)

try:
    api_response = api_instance.search_creative_get(aesthetics=aesthetics, tags=tags, page=page)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->search_creative_get: %s\n" % e)
```
...
try:
    api_instance.search_creative_options()
except ApiException as e:
    print("Exception when calling DefaultApi->search_creative_options: %s\n" % e)
```
...
try:
    api_instance.upload_node_options()
except ApiException as e:
    print("Exception when calling DefaultApi->upload_node_options: %s\n" % e)
```
...
# **upload_node_post**
> UploadResponse upload_node_post(upload_request)
...
# create an instance of the API class
api_instance = swagger_client.DefaultApi(swagger_client.ApiClient(configuration))
upload_request = swagger_client.UploadRequest() # UploadRequest | 

try:
    api_response = api_instance.upload_node_post(upload_request)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->upload_node_post: %s\n" % e)
```
...
> AnyResponse user_activity_stream_get(after=after, limit=limit)
...
try:
    api_response = api_instance.user_activity_stream_get(after=after, limit=limit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->user_activity_stream_get: %s\n" % e)
```
...
try:
    api_instance.user_activity_stream_options()
except ApiException as e:
    print("Exception when calling DefaultApi->user_activity_stream_options: %s\n" % e)
```
...
> UserAvailabilityResponse user_availability_get(username=username)
...
try:
    api_response = api_instance.user_availability_get(username=username)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->user_availability_get: %s\n" % e)
```
...
try:
    api_instance.user_availability_options()
except ApiException as e:
    print("Exception when calling DefaultApi->user_availability_options: %s\n" % e)
```
...
# **user_current_get**
> UserReadPrivateResponse user_current_get()
...
try:
    ...
    print("Exception when calling DefaultApi->user_current_get: %s\n" % e)
```
...
try:
    api_instance.user_current_options()
except ApiException as e:
    print("Exception when calling DefaultApi->user_current_options: %s\n" % e)
```
...
# **user_delete**
> OkResponse user_delete(user_delete_request)
...
# create an instance of the API class
api_instance = swagger_client.DefaultApi(swagger_client.ApiClient(configuration))
user_delete_request = swagger_client.UserDeleteRequest() # UserDeleteRequest | 

try:
    api_response = api_instance.user_delete(user_delete_request)
    pprint(api_response)
except ApiException as e:
...
# **user_get**
> UserReadPublicResponse user_get(username=username, id=id)
...
try:
    api_response = api_instance.user_get(username=username, id=id)
    pprint(api_response)
except ApiException as e:
...
try:
    api_instance.user_invite_options()
except ApiException as e:
    print("Exception when calling DefaultApi->user_invite_options: %s\n" % e)
```
...
# create an instance of the API class
api_instance = swagger_client.DefaultApi(swagger_client.ApiClient(configuration))
user_invite_request = swagger_client.UserInviteRequest() # UserInviteRequest | 

try:
    api_response = api_instance.user_invite_post(user_invite_request)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->user_invite_post: %s\n" % e)
```
...
> UserPagedListReadPublicResponse user_list_search_get(direction=direction, content_type=content_type, page=page, order_by=order_by, q=q)
...
try:
    api_response = api_instance.user_list_search_get(direction=direction, content_type=content_type, page=page, order_by=order_by, q=q)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->user_list_search_get: %s\n" % e)
```
...
try:
    api_instance.user_list_search_options()
except ApiException as e:
    print("Exception when calling DefaultApi->user_list_search_options: %s\n" % e)
```
...
# **user_list_top_get**
> UserPagedListReadPublicResponse user_list_top_get(direction=direction, content_type=content_type, page=page, order_by=order_by)
...
try:
    api_response = api_instance.user_list_top_get(direction=direction, content_type=content_type, page=page, order_by=order_by)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->user_list_top_get: %s\n" % e)
```
...
try:
    api_instance.user_list_top_options()
except ApiException as e:
    print("Exception when calling DefaultApi->user_list_top_options: %s\n" % e)
```
...
# **user_moods_get**
> MoodPagedListReadPublicResponse user_moods_get(id=id, page=page)
...
try:
    api_response = api_instance.user_moods_get(id=id, page=page)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->user_moods_get: %s\n" % e)
```
...
try:
    api_instance.user_moods_options()
except ApiException as e:
    print("Exception when calling DefaultApi->user_moods_options: %s\n" % e)
```
...
try:
    api_instance.user_options()
except ApiException as e:
    print("Exception when calling DefaultApi->user_options: %s\n" % e)
```
...
# **user_post**
> UserReadPrivateResponse user_post(user_create_request)
...
# create an instance of the API class
api_instance = swagger_client.DefaultApi(swagger_client.ApiClient(configuration))
user_create_request = swagger_client.UserCreateRequest() # UserCreateRequest | 

try:
    api_response = api_instance.user_post(user_create_request)
    pprint(api_response)
except ApiException as e:
...
try:
    api_instance.user_preregister_options()
except ApiException as e:
    print("Exception when calling DefaultApi->user_preregister_options: %s\n" % e)
```
...
> UserReadPrivateResponse user_preregister_post(user_pre_register_request)
...
# create an instance of the API class
api_instance = swagger_client.DefaultApi(swagger_client.ApiClient(configuration))
user_pre_register_request = swagger_client.UserPreRegisterRequest() # UserPreRegisterRequest | 

try:
    api_response = api_instance.user_preregister_post(user_pre_register_request)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->user_preregister_post: %s\n" % e)
```
...
# **user_put**
> UserReadPrivateResponse user_put(user_update_request)
...
# create an instance of the API class
api_instance = swagger_client.DefaultApi(swagger_client.ApiClient(configuration))
user_update_request = swagger_client.UserUpdateRequest() # UserUpdateRequest | 

try:
    api_response = api_instance.user_put(user_update_request)
    pprint(api_response)
except ApiException as e:
...
# **user_rated_in_get**
> PagedRatedResponseUser user_rated_in_get(id=id, page=page)
...
try:
    api_response = api_instance.user_rated_in_get(id=id, page=page)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->user_rated_in_get: %s\n" % e)
```
...
try:
    api_instance.user_rated_in_options()
except ApiException as e:
    print("Exception when calling DefaultApi->user_rated_in_options: %s\n" % e)
```
...
> PagedRatedResponsePost user_rated_out_posts_get(id=id, page=page)
...
try:
    api_response = api_instance.user_rated_out_posts_get(id=id, page=page)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->user_rated_out_posts_get: %s\n" % e)
```
...
try:
    api_instance.user_rated_out_posts_options()
except ApiException as e:
    print("Exception when calling DefaultApi->user_rated_out_posts_options: %s\n" % e)
```
...
> PagedRatedResponseUser user_rated_out_users_get(id=id, page=page)
...
try:
    api_response = api_instance.user_rated_out_users_get(id=id, page=page)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->user_rated_out_users_get: %s\n" % e)
```
...
try:
    api_instance.user_rated_out_users_options()
except ApiException as e:
    print("Exception when calling DefaultApi->user_rated_out_users_options: %s\n" % e)
```
...
try:
    api_instance.user_stake_options()
except ApiException as e:
    print("Exception when calling DefaultApi->user_stake_options: %s\n" % e)
```
...
# **user_stake_post**
> AnyResponse user_stake_post(user_stake_request)
...
# create an instance of the API class
api_instance = swagger_client.DefaultApi(swagger_client.ApiClient(configuration))
user_stake_request = swagger_client.UserStakeRequest() # UserStakeRequest | 

try:
    api_response = api_instance.user_stake_post(user_stake_request)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->user_stake_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **user_stake_request** | [**UserStakeRequest**](UserStakeRequest.md)|  | 
...
try:
    api_instance.user_sync_contacts_options()
except ApiException as e:
    print("Exception when calling DefaultApi->user_sync_contacts_options: %s\n" % e)
```
...
# **user_sync_contacts_post**
> SyncContactsResponse user_sync_contacts_post(sync_contacts_request)
...
# create an instance of the API class
api_instance = swagger_client.DefaultApi(swagger_client.ApiClient(configuration))
sync_contacts_request = swagger_client.SyncContactsRequest() # SyncContactsRequest | 

try:
    api_response = api_instance.user_sync_contacts_post(sync_contacts_request)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->user_sync_contacts_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **sync_contacts_request** | [**SyncContactsRequest**](SyncContactsRequest.md)|  | 
...
try:
    api_instance.user_upload_options()
except ApiException as e:
    print("Exception when calling DefaultApi->user_upload_options: %s\n" % e)
```
...
# **user_upload_post**
> UploadResponse user_upload_post(user_upload_request)
...
# create an instance of the API class
api_instance = swagger_client.DefaultApi(swagger_client.ApiClient(configuration))
user_upload_request = swagger_client.UserUploadRequest() # UserUploadRequest | 

try:
    api_response = api_instance.user_upload_post(user_upload_request)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->user_upload_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **user_upload_request** | [**UserUploadRequest**](UserUploadRequest.md)|  | 
...
try:
    api_instance.user_user_rate_options()
except ApiException as e:
    print("Exception when calling DefaultApi->user_user_rate_options: %s\n" % e)
```
...
# **user_user_rate_post**
> RatingUpdateResponse user_user_rate_post(rating_update_request)
...
try:
    api_response = api_instance.user_user_rate_post(rating_update_request)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->user_user_rate_post: %s\n" % e)
```

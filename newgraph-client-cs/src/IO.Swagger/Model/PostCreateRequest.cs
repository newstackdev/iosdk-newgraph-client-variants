...
namespace IO.Swagger.Model
{
    ...
    public partial class PostCreateRequest :  IEquatable<PostCreateRequest>, IValidatableObject
    {
        ...
        public PostCreateRequest(string license = default(string), string doMint = default(string), string description = default(string), string title = default(string), string contentType = default(string), string content = default(string))
        {

...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserInvitationPagedListReadPublicResponseValue :  IEquatable<UserInvitationPagedListReadPublicResponseValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserInvitationPagedListReadPublicResponseValue" /> class.
        /// </summary>
        ...
        public UserInvitationPagedListReadPublicResponseValue(string newcoinTicker = default(string), string youtube = default(string), decimal? powered = default(decimal?), string displayName = default(string), string newcoinAccTx = default(string), decimal? latitude = default(decimal?), string description = default(string), string newcoinPoolId = default(string), string tumblr = default(string), decimal? aspectRatio = default(decimal?), string instagram = default(string), string medium = default(string), string newcoinActivePublicKey = default(string), string soundcloud = default(string), string newcoinPublicKey = default(string), decimal? powering = default(decimal?), string snapchat = default(string), string apple = default(string), string twitter = default(string), string newcoinOwnerPublicKey = default(string), string tiktok = default(string), string reddit = default(string), string youtubeId = default(string), string id = default(string), decimal? newcoinPoolStake = default(decimal?), string contentType = default(string), string signal = default(string), decimal? longitude = default(decimal?), string newcoinPublisherPublicKey = default(string), string website = default(string), string created = default(string), UserInvitationPagedListReadPublicResponseInvitation invitation = default(UserInvitationPagedListReadPublicResponseInvitation), string spotify = default(string), string facebook = default(string), string facebookId = default(string), string fullName = default(string), string telegram = default(string), string pinterest = default(string), List<string> verifiedSocialIds = default(List<string>), string newcoinPoolTx = default(string), string license = default(string), string contentUrl = default(string), string discord = default(string), string blurHash = default(string), string consentEmail = default(string), string updated = default(string), string username = default(string))
        {
        ...
        public UserInvitationPagedListReadPublicResponseInvitation Invitation { get; set; }
        ...
        {
            return this.Equals(input as UserInvitationPagedListReadPublicResponseValue);
        }

        /// <summary>
        /// Returns true if UserInvitationPagedListReadPublicResponseValue instances are equal
        /// </summary>
        /// <param name="input">Instance of UserInvitationPagedListReadPublicResponseValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserInvitationPagedListReadPublicResponseValue input)
        {
            if (input == null)
                return false;

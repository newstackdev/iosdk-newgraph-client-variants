...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MoodPagedListReadPublicResponsePosts :  IEquatable<MoodPagedListReadPublicResponsePosts>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MoodPagedListReadPublicResponsePosts" /> class.
        /// </summary>
        ...
        public MoodPagedListReadPublicResponsePosts(string coverContentUrl = default(string), string moodId = default(string), string created = default(string), MoodPagedListReadPublicResponseAuthor author = default(MoodPagedListReadPublicResponseAuthor), decimal? latitude = default(decimal?), List<MoodPagedListReadPublicResponseMoods> moods = default(List<MoodPagedListReadPublicResponseMoods>), string description = default(string), decimal? aspectRatio = default(decimal?), string title = default(string), string content = default(string), List<MoodPagedListReadPublicResponseTags> tags = default(List<MoodPagedListReadPublicResponseTags>), string license = default(string), string contentUrl = default(string), string blurHash = default(string), string newcoinMintTx = default(string), string id = default(string), string consentEmail = default(string), string updated = default(string), string contentType = default(string), decimal? longitude = default(decimal?))
        {
        ...
        {
            return this.Equals(input as MoodPagedListReadPublicResponsePosts);
        }

        /// <summary>
        /// Returns true if MoodPagedListReadPublicResponsePosts instances are equal
        /// </summary>
        /// <param name="input">Instance of MoodPagedListReadPublicResponsePosts to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MoodPagedListReadPublicResponsePosts input)
        {
            if (input == null)
                return false;

...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MoodPagedListReadPublicResponseMoods :  IEquatable<MoodPagedListReadPublicResponseMoods>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MoodPagedListReadPublicResponseMoods" /> class.
        /// </summary>
        ...
        public MoodPagedListReadPublicResponseMoods(string created = default(string), MoodPagedListReadPublicResponseAuthor author = default(MoodPagedListReadPublicResponseAuthor), decimal? latitude = default(decimal?), string description = default(string), decimal? aspectRatio = default(decimal?), string title = default(string), string content = default(string), decimal? stakeToAccess = default(decimal?), List<MoodPagedListReadPublicResponseTags> tags = default(List<MoodPagedListReadPublicResponseTags>), string contentUrl = default(string), decimal? postsCount = default(decimal?), string blurHash = default(string), string id = default(string), string updated = default(string), string contentType = default(string), decimal? longitude = default(decimal?))
        {
        ...
        {
            return this.Equals(input as MoodPagedListReadPublicResponseMoods);
        }

        /// <summary>
        /// Returns true if MoodPagedListReadPublicResponseMoods instances are equal
        /// </summary>
        /// <param name="input">Instance of MoodPagedListReadPublicResponseMoods to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MoodPagedListReadPublicResponseMoods input)
        {
            if (input == null)
                return false;

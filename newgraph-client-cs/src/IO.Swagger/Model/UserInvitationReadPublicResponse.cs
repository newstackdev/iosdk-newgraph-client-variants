...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserInvitationReadPublicResponse :  IEquatable<UserInvitationReadPublicResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserInvitationReadPublicResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UserInvitationReadPublicResponse);
        }

        /// <summary>
        /// Returns true if UserInvitationReadPublicResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UserInvitationReadPublicResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserInvitationReadPublicResponse input)
        {
            if (input == null)
                return false;

...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PostCreateResponseAuthor :  IEquatable<PostCreateResponseAuthor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostCreateResponseAuthor" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PostCreateResponseAuthor);
        }

        /// <summary>
        /// Returns true if PostCreateResponseAuthor instances are equal
        /// </summary>
        /// <param name="input">Instance of PostCreateResponseAuthor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostCreateResponseAuthor input)
        {
            if (input == null)
                return false;

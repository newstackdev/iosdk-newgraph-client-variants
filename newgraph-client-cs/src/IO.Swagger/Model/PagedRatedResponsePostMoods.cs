...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PagedRatedResponsePostMoods :  IEquatable<PagedRatedResponsePostMoods>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedRatedResponsePostMoods" /> class.
        /// </summary>
        ...
        public PagedRatedResponsePostMoods(string created = default(string), PagedRatedResponsePostAuthor author = default(PagedRatedResponsePostAuthor), decimal? latitude = default(decimal?), string description = default(string), decimal? aspectRatio = default(decimal?), string title = default(string), string content = default(string), decimal? stakeToAccess = default(decimal?), List<PagedRatedResponsePostTags> tags = default(List<PagedRatedResponsePostTags>), string contentUrl = default(string), decimal? postsCount = default(decimal?), string blurHash = default(string), string id = default(string), string updated = default(string), string contentType = default(string), decimal? longitude = default(decimal?))
        {
        ...
        {
            return this.Equals(input as PagedRatedResponsePostMoods);
        }

        /// <summary>
        /// Returns true if PagedRatedResponsePostMoods instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedRatedResponsePostMoods to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedRatedResponsePostMoods input)
        {
            if (input == null)
                return false;

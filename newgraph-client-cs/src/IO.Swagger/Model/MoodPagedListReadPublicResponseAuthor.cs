...
namespace IO.Swagger.Model
{
    ...
    public partial class MoodPagedListReadPublicResponseAuthor :  IEquatable<MoodPagedListReadPublicResponseAuthor>, IValidatableObject
    {
        ...
        /// <param name="confirmedSocials">confirmedSocials.</param>
        ...
        public MoodPagedListReadPublicResponseAuthor(string newcoinTicker = default(string), string youtube = default(string), decimal? powered = default(decimal?), string displayName = default(string), string newcoinAccTx = default(string), decimal? latitude = default(decimal?), string description = default(string), string newcoinPoolId = default(string), string tumblr = default(string), decimal? aspectRatio = default(decimal?), string instagram = default(string), string medium = default(string), string newcoinActivePublicKey = default(string), string soundcloud = default(string), string newcoinPublicKey = default(string), decimal? powering = default(decimal?), string snapchat = default(string), string apple = default(string), string twitter = default(string), string newcoinOwnerPublicKey = default(string), string tiktok = default(string), string reddit = default(string), string id = default(string), decimal? newcoinPoolStake = default(decimal?), string contentType = default(string), string signal = default(string), decimal? longitude = default(decimal?), string newcoinPublisherPublicKey = default(string), string website = default(string), string created = default(string), string spotify = default(string), string facebook = default(string), string confirmedSocials = default(string), string fullName = default(string), string telegram = default(string), string pinterest = default(string), List<string> verifiedSocialIds = default(List<string>), string newcoinPoolTx = default(string), string license = default(string), string contentUrl = default(string), string discord = default(string), string blurHash = default(string), string consentEmail = default(string), string updated = default(string), string username = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets ConfirmedSocials
        /// </summary>
        [DataMember(Name="confirmedSocials", EmitDefaultValue=false)]
        public string ConfirmedSocials { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ConfirmedSocials: ").Append(ConfirmedSocials).Append("\n");
        ...
        public bool Equals(MoodPagedListReadPublicResponseAuthor input)
        {
            ...
            return 
                ...
                (
                    this.ConfirmedSocials == input.ConfirmedSocials ||
                    (this.ConfirmedSocials != null &&
                    this.ConfirmedSocials.Equals(input.ConfirmedSocials))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ConfirmedSocials != null)
                    hashCode = hashCode * 59 + this.ConfirmedSocials.GetHashCode();

...
namespace IO.Swagger.Model
{
    ...
    public partial class MoodCreateResponse :  IEquatable<MoodCreateResponse>, IValidatableObject
    {
        ...
        public MoodCreateResponse(string created = default(string), MoodPagedListReadPublicResponseAuthor author = default(MoodPagedListReadPublicResponseAuthor), decimal? latitude = default(decimal?), string description = default(string), decimal? aspectRatio = default(decimal?), string title = default(string), List<MoodPagedListReadPublicResponsePosts> posts = default(List<MoodPagedListReadPublicResponsePosts>), string content = default(string), decimal? stakeToAccess = default(decimal?), List<MoodPagedListReadPublicResponseTags> tags = default(List<MoodPagedListReadPublicResponseTags>), string contentUrl = default(string), decimal? postsCount = default(decimal?), string blurHash = default(string), string id = default(string), string updated = default(string), string contentType = default(string), decimal? longitude = default(decimal?))
        {

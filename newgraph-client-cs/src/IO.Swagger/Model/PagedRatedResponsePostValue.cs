...
namespace IO.Swagger.Model
{
    ...
    public partial class PagedRatedResponsePostValue :  IEquatable<PagedRatedResponsePostValue>, IValidatableObject
    {
        ...
        public PagedRatedResponsePostValue(string coverContentUrl = default(string), string moodId = default(string), string created = default(string), MoodPagedListReadPublicResponseAuthor author = default(MoodPagedListReadPublicResponseAuthor), decimal? latitude = default(decimal?), List<MoodPagedListReadPublicResponseMoods> moods = default(List<MoodPagedListReadPublicResponseMoods>), PagedRatedResponseUserRating rating = default(PagedRatedResponseUserRating), string description = default(string), decimal? aspectRatio = default(decimal?), string title = default(string), string content = default(string), List<MoodPagedListReadPublicResponseTags> tags = default(List<MoodPagedListReadPublicResponseTags>), string license = default(string), string contentUrl = default(string), string blurHash = default(string), string newcoinMintTx = default(string), string id = default(string), string embed = default(string), string updated = default(string), string contentType = default(string), decimal? longitude = default(decimal?))
        {

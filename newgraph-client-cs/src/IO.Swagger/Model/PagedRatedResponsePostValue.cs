...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PagedRatedResponsePostValue :  IEquatable<PagedRatedResponsePostValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedRatedResponsePostValue" /> class.
        /// </summary>
        ...
        public PagedRatedResponsePostValue(string coverContentUrl = default(string), string moodId = default(string), string created = default(string), PagedRatedResponsePostAuthor author = default(PagedRatedResponsePostAuthor), decimal? latitude = default(decimal?), List<PagedRatedResponsePostMoods> moods = default(List<PagedRatedResponsePostMoods>), PagedRatedResponseUserRating rating = default(PagedRatedResponseUserRating), string description = default(string), decimal? aspectRatio = default(decimal?), string title = default(string), string content = default(string), List<PagedRatedResponsePostTags> tags = default(List<PagedRatedResponsePostTags>), string license = default(string), string contentUrl = default(string), string blurHash = default(string), string newcoinMintTx = default(string), string id = default(string), string consentEmail = default(string), string updated = default(string), string contentType = default(string), decimal? longitude = default(decimal?))
        {
        ...
        {
            return this.Equals(input as PagedRatedResponsePostValue);
        }

        /// <summary>
        /// Returns true if PagedRatedResponsePostValue instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedRatedResponsePostValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedRatedResponsePostValue input)
        {
            if (input == null)
                return false;

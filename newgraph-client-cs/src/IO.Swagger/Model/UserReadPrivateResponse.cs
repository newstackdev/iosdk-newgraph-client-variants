...
namespace IO.Swagger.Model
{
    ...
    public partial class UserReadPrivateResponse :  IEquatable<UserReadPrivateResponse>, IValidatableObject
    {
        ...
        public UserReadPrivateResponse(decimal? powered = default(decimal?), string newcoinAccTx = default(string), string newcoinPoolId = default(string), decimal? aspectRatio = default(decimal?), string instagram = default(string), string newcoinActivePublicKey = default(string), string newcoinPublicKey = default(string), decimal? powering = default(decimal?), string stripeUid = default(string), string twitter = default(string), string newcoinOwnerPublicKey = default(string), string tiktok = default(string), string reddit = default(string), string id = default(string), string contentType = default(string), string signal = default(string), decimal? longitude = default(decimal?), string subscriptionExpiry = default(string), string created = default(string), string newcoinPoolTx = default(string), List<string> verifiedSocialIds = default(List<string>), string firstName = default(string), string license = default(string), string discord = default(string), string phone = default(string), string updated = default(string), string status = default(string), string youtube = default(string), string lastName = default(string), string consentPrivacyPolicy = default(string), string displayName = default(string), decimal? latitude = default(decimal?), string description = default(string), string tumblr = default(string), string medium = default(string), string soundcloud = default(string), string snapchat = default(string), string apple = default(string), string consentTestgroup = default(string), string newcoinPrivateKey = default(string), string subscriptionStatus = default(string), string newcoinPublisherPrivateKey = default(string), decimal? newcoinPoolStake = default(decimal?), string email = default(string), string newcoinPublisherPublicKey = default(string), string website = default(string), string spotify = default(string), string facebook = default(string), string fullName = default(string), string telegram = default(string), string pinterest = default(string), string contentUrl = default(string), string blurHash = default(string), string consentEmail = default(string), string username = default(string))
        {

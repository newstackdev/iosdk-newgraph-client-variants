...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PostCreateResponseMoods :  IEquatable<PostCreateResponseMoods>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostCreateResponseMoods" /> class.
        /// </summary>
        ...
        public PostCreateResponseMoods(string created = default(string), PostCreateResponseAuthor author = default(PostCreateResponseAuthor), decimal? latitude = default(decimal?), string description = default(string), decimal? aspectRatio = default(decimal?), string title = default(string), string content = default(string), decimal? stakeToAccess = default(decimal?), List<MoodPagedListReadPublicResponseTags> tags = default(List<MoodPagedListReadPublicResponseTags>), string contentUrl = default(string), decimal? postsCount = default(decimal?), string blurHash = default(string), string id = default(string), string updated = default(string), string contentType = default(string), decimal? longitude = default(decimal?))
        {
        ...
        {
            return this.Equals(input as PostCreateResponseMoods);
        }

        /// <summary>
        /// Returns true if PostCreateResponseMoods instances are equal
        /// </summary>
        /// <param name="input">Instance of PostCreateResponseMoods to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostCreateResponseMoods input)
        {
            if (input == null)
                return false;

...
namespace IO.Swagger.Model
{
    ...
    public partial class BcDaoProposalVoteResponse :  IEquatable<BcDaoProposalVoteResponse>, IValidatableObject
    {
        ...
        public BcDaoProposalVoteResponse(string daoId = default(string), bool? more = default(bool?), string nextKey = default(string), List<BcDaoProposalVoteResponseRows> rows = default(List<BcDaoProposalVoteResponseRows>))
        {
            this.DaoId = daoId;
            this.More = more;

...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MoodReadResponse :  IEquatable<MoodReadResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MoodReadResponse" /> class.
        /// </summary>
        ...
        public MoodReadResponse(string created = default(string), MoodPagedListReadPublicResponseAuthor author = default(MoodPagedListReadPublicResponseAuthor), decimal? latitude = default(decimal?), string description = default(string), decimal? aspectRatio = default(decimal?), string title = default(string), List<MoodPagedListReadPublicResponsePosts> posts = default(List<MoodPagedListReadPublicResponsePosts>), string content = default(string), decimal? stakeToAccess = default(decimal?), List<MoodPagedListReadPublicResponseTags> tags = default(List<MoodPagedListReadPublicResponseTags>), string contentUrl = default(string), decimal? postsCount = default(decimal?), string blurHash = default(string), string id = default(string), string updated = default(string), string contentType = default(string), decimal? longitude = default(decimal?))
        {
        ...
        {
            return this.Equals(input as MoodReadResponse);
        }

        /// <summary>
        /// Returns true if MoodReadResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MoodReadResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MoodReadResponse input)
        {
            if (input == null)
                return false;

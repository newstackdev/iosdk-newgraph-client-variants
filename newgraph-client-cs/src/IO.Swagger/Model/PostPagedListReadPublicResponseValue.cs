...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PostPagedListReadPublicResponseValue :  IEquatable<PostPagedListReadPublicResponseValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostPagedListReadPublicResponseValue" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PostPagedListReadPublicResponseValue);
        }

        /// <summary>
        /// Returns true if PostPagedListReadPublicResponseValue instances are equal
        /// </summary>
        /// <param name="input">Instance of PostPagedListReadPublicResponseValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostPagedListReadPublicResponseValue input)
        {
            if (input == null)
                return false;

...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PagedRatedResponseUserRating :  IEquatable<PagedRatedResponseUserRating>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedRatedResponseUserRating" /> class.
        /// </summary>
        /// <param name="created">created.</param>
        /// <param name="txIDMintAsset">txIDMintAsset.</param>
        /// <param name="value">value.</param>
        /// <param name="updated">updated.</param>
        public PagedRatedResponseUserRating(string created = default(string), string txIDMintAsset = default(string), decimal? value = default(decimal?), string updated = default(string))
        {
        ...
        {
            return this.Equals(input as PagedRatedResponseUserRating);
        }

        /// <summary>
        /// Returns true if PagedRatedResponseUserRating instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedRatedResponseUserRating to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedRatedResponseUserRating input)
        {
            if (input == null)
                return false;

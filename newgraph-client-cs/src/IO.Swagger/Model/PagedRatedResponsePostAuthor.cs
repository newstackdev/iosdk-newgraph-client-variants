...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PagedRatedResponsePostAuthor :  IEquatable<PagedRatedResponsePostAuthor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedRatedResponsePostAuthor" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PagedRatedResponsePostAuthor);
        }

        /// <summary>
        /// Returns true if PagedRatedResponsePostAuthor instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedRatedResponsePostAuthor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedRatedResponsePostAuthor input)
        {
            if (input == null)
                return false;

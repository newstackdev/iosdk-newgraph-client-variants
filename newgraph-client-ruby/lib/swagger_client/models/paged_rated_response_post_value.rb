...
module SwaggerClient
  class PagedRatedResponsePostValue
    ...
    def hash
      [cover_content_url, mood_id, created, author, latitude, moods, rating, description, aspect_ratio, title, content, tags, license, content_url, blur_hash, newcoin_mint_tx, id, embed, updated, content_type, longitude].hash
    end

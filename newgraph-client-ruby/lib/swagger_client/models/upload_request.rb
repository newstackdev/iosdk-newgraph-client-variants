...
module SwaggerClient
  class UploadRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'targetModel')
        self.target_model = attributes[:'targetModel']
      end
    ...
    def list_invalid_properties
      ...
      if @target_model.nil?
        invalid_properties.push('invalid value for "target_model", target_model cannot be nil.')
      end
    ...
    def hash
      [filename, target_id, target_model, content_type].hash
    end

...
module SwaggerClient
  class BcDaoProposalVoteRequest
    ...
    def list_invalid_properties
      ...
      if @proposal_id.nil?
        invalid_properties.push('invalid value for "proposal_id", proposal_id cannot be nil.')
      end

      if @voter.nil?
        invalid_properties.push('invalid value for "voter", voter cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @proposal_id.nil?
    ...
    def hash
      [proposal_type, quantity, proposal_id, dao_id, dao_owner, voter, option].hash
    end

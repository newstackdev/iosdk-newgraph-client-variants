...
module SwaggerClient
  class MoodPagedListReadPublicResponseAuthor
    ...
    attr_accessor :confirmed_socials
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'confirmedSocials')
        self.confirmed_socials = attributes[:'confirmedSocials']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          spotify == o.spotify &&
          facebook == o.facebook &&
          confirmed_socials == o.confirmed_socials &&
    ...
    def hash
      [newcoin_ticker, youtube, powered, display_name, newcoin_acc_tx, latitude, description, newcoin_pool_id, tumblr, aspect_ratio, instagram, medium, newcoin_active_public_key, soundcloud, newcoin_public_key, powering, snapchat, apple, twitter, newcoin_owner_public_key, tiktok, reddit, id, newcoin_pool_stake, content_type, signal, longitude, newcoin_publisher_public_key, website, created, spotify, facebook, confirmed_socials, full_name, telegram, pinterest, verified_social_ids, newcoin_pool_tx, license, content_url, discord, blur_hash, consent_email, updated, username].hash
    end

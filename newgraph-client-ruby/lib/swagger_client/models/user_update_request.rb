...
module SwaggerClient
  class UserUpdateRequest
    ...
    attr_accessor :newcoin_create_account
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'newcoinCreateAccount')
        self.newcoin_create_account = attributes[:'newcoinCreateAccount']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          latitude == o.latitude &&
          newcoin_create_account == o.newcoin_create_account &&
    ...
    def hash
      [youtube, last_name, consent_privacy_policy, display_name, latitude, newcoin_create_account, description, tumblr, instagram, medium, soundcloud, snapchat, apple, twitter, tiktok, reddit, id, signal, longitude, website, spotify, facebook, full_name, telegram, pinterest, first_name, discord, consent_email].hash
    end

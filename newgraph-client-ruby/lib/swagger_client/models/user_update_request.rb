...
module SwaggerClient
  class UserUpdateRequest
    ...
    def hash
      [last_name, website, consent_privacy_policy, display_name, latitude, newcoin_create_account, full_name, tumblr, description, instagram, soundcloud, first_name, twitter, tiktok, id, consent_email, longitude].hash
    end

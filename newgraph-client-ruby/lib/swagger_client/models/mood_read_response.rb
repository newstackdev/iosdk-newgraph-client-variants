...
module SwaggerClient
  class MoodReadResponse
    ...
    def self.swagger_types
      {
        ...
        :'aspect_ratio' => :'Float',
        :'title' => :'String',
        :'posts' => :'Array<MoodCreateResponsePosts>',
        :'content' => :'String',
        :'stake_to_access' => :'Float',
        :'tags' => :'Array<PagedRatedResponsePostTags>',
        :'content_url' => :'String',
        :'posts_count' => :'Float',
        :'blur_hash' => :'String',
        :'id' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'stakeToAccess')
        self.stake_to_access = attributes[:'stakeToAccess']
      end
      ...
      if attributes.has_key?(:'postsCount')
        self.posts_count = attributes[:'postsCount']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          posts == o.posts &&
          content == o.content &&
          stake_to_access == o.stake_to_access &&
          tags == o.tags &&
    ...
    def hash
      [created, author, latitude, description, aspect_ratio, title, posts, content, stake_to_access, tags, content_url, posts_count, blur_hash, id, updated, content_type, longitude].hash
    end

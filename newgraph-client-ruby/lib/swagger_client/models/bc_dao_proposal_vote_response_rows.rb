...
module SwaggerClient
  class BcDaoProposalVoteResponseRows
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'lock_end_date')
        self.lock_end_date = attributes[:'lock_end_date']
      end
    end
    ...
    def hash
      [proposal_type, quantity, proposal_id, dao_id, id, lock_end_date].hash
    end

...
module SwaggerClient
  class PagedRatedResponsePostMoods
    ...
    def hash
      [created, author, latitude, description, aspect_ratio, title, content, stake_to_access, tags, content_url, posts_count, blur_hash, id, updated, content_type, longitude].hash
    end

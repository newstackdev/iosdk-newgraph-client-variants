...
module SwaggerClient
  class UserReadPrivateResponse
    ...
    def hash
      [powered, newcoin_acc_tx, newcoin_pool_id, aspect_ratio, instagram, newcoin_active_public_key, newcoin_public_key, powering, stripe_uid, twitter, newcoin_owner_public_key, tiktok, reddit, id, content_type, signal, longitude, subscription_expiry, created, newcoin_pool_tx, verified_social_ids, first_name, license, discord, phone, updated, status, youtube, last_name, consent_privacy_policy, display_name, latitude, description, tumblr, medium, soundcloud, snapchat, apple, consent_testgroup, newcoin_private_key, subscription_status, newcoin_publisher_private_key, newcoin_pool_stake, email, newcoin_publisher_public_key, website, spotify, facebook, full_name, telegram, pinterest, content_url, blur_hash, consent_email, username].hash
    end

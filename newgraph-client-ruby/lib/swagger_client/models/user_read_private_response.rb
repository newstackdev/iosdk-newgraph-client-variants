...
module SwaggerClient
  class UserReadPrivateResponse
    ...
    def hash
      [last_name, consent_privacy_policy, powered, display_name, newcoin_acc_tx, latitude, tumblr, description, newcoin_pool_id, aspect_ratio, instagram, soundcloud, newcoin_active_public_key, newcoin_public_key, powering, stripe_uid, twitter, consent_testgroup, newcoin_private_key, newcoin_owner_public_key, tiktok, subscription_status, newcoin_publisher_private_key, id, newcoin_pool_stake, content_type, email, longitude, newcoin_publisher_public_key, website, subscription_expiry, created, full_name, newcoin_pool_tx, first_name, license, content_url, phone, blur_hash, consent_email, updated, username, status].hash
    end

...
module SwaggerClient
  class RatingUpdateRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'contextType')
        self.context_type = attributes[:'contextType']
      end

      if attributes.has_key?(:'contextValue')
        self.context_value = attributes[:'contextValue']
      end
    ...
    def hash
      [target_id, context_type, context_value, value].hash
    end

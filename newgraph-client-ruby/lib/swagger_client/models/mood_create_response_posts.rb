...
module SwaggerClient
  class MoodCreateResponsePosts
    ...
    def hash
      [cover_content_url, mood_id, created, author, latitude, moods, description, aspect_ratio, title, content, tags, license, content_url, blur_hash, newcoin_mint_tx, id, consent_email, updated, content_type, longitude].hash
    end

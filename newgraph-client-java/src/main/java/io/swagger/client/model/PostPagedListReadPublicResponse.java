...
import io.swagger.client.model.PostPagedListReadPublicResponseValue;
...
public class PostPagedListReadPublicResponse {
  ...
  private List<PostPagedListReadPublicResponseValue> value = null;

  @SerializedName("done")
  private Boolean done = null;

  public PostPagedListReadPublicResponse value(List<PostPagedListReadPublicResponseValue> value) {
    this.value = value;
    return this;
  }

  public PostPagedListReadPublicResponse addValueItem(PostPagedListReadPublicResponseValue valueItem) {
    if (this.value == null) {
      this.value = new ArrayList<PostPagedListReadPublicResponseValue>();
    }
  ...
  **/
  ...
  public List<PostPagedListReadPublicResponseValue> getValue() {
    return value;
  }

  public void setValue(List<PostPagedListReadPublicResponseValue> value) {
    this.value = value;
  }

...
public class DefaultApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call newcoinDaoProposalVotesGetCall(String reverse, String limit, String upperBound, String voter, String lowerBound, String voteId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    private com.squareup.okhttp.Call newcoinDaoProposalVotesGetValidateBeforeCall(String reverse, String limit, String upperBound, String voter, String lowerBound, String voteId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = newcoinDaoProposalVotesGetCall(reverse, limit, upperBound, voter, lowerBound, voteId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public BcDaoProposalVoteResponse newcoinDaoProposalVotesGet(String reverse, String limit, String upperBound, String voter, String lowerBound, String voteId) throws ApiException {
        ApiResponse<BcDaoProposalVoteResponse> resp = newcoinDaoProposalVotesGetWithHttpInfo(reverse, limit, upperBound, voter, lowerBound, voteId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<BcDaoProposalVoteResponse> newcoinDaoProposalVotesGetWithHttpInfo(String reverse, String limit, String upperBound, String voter, String lowerBound, String voteId) throws ApiException {
        com.squareup.okhttp.Call call = newcoinDaoProposalVotesGetValidateBeforeCall(reverse, limit, upperBound, voter, lowerBound, voteId, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call newcoinDaoProposalVotesGetAsync(String reverse, String limit, String upperBound, String voter, String lowerBound, String voteId, final ApiCallback<BcDaoProposalVoteResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = newcoinDaoProposalVotesGetValidateBeforeCall(reverse, limit, upperBound, voter, lowerBound, voteId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<BcDaoProposalVoteResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
